...
<script src="<%=request.getContextPath()%>/js/validate/depends/prototype.js" language="javascript"></script>
<script src="<%=request.getContextPath()%>/js/validate/depends/static-prototype.js" language="javascript"></script>
