...
(function (b) {
    b.jgrid = b.jgrid || {};
    b.extend(b.jgrid, {version: "4.4.3", htmlDecode: function (b) {
        ...
        null == f && (f = "");
        return f.replace(/\{(\d+)\}/g, function (b, d) {
            return e[d]
        })
        ...
        var c = {m: 1, d: 1, y: 1970,
            h: 0, i: 0, s: 0, u: 0}, d, a, i;
        d = /[\\\/:_;.,\t\T\s-]/;
        if (e && null != e) {
            e = b.trim(e);
            e = e.split(d);
            void 0 !== b.jgrid.formatter.date.masks[f] && (f = b.jgrid.formatter.date.masks[f]);
            var f = f.split(d), h = b.jgrid.formatter.date.monthNames, g = b.jgrid.formatter.date.AmPm, j = function (a, b) {
                0 === a ? 12 === b && (b = 0) : 12 !== b && (b += 12);
                return b
            };
            d = 0;
            for (a = f.length; d < a; d++)"M" == f[d] && (i = b.inArray(e[d], h), -1 !== i && 12 > i && (e[d] = i + 1, c.m = e[d])), "F" == f[d] && (i = b.inArray(e[d], h), -1 !== i && 11 < i && (e[d] = i + 1 - 12, c.m = e[d])), "a" == f[d] && (i = b.inArray(e[d],
                g), -1 !== i && 2 > i && e[d] == g[i] && (e[d] = i, c.h = j(e[d], c.h))), "A" == f[d] && (i = b.inArray(e[d], g), -1 !== i && 1 < i && e[d] == g[i] && (e[d] = i - 2, c.h = j(e[d], c.h))), "g" === f[d] && (c.h = parseInt(e[d], 10)), void 0 !== e[d] && (c[f[d].toLowerCase()] = parseInt(e[d], 10));
        ...
        c = b[e];
        if (void 0 === c)try {
            if ("string" === typeof e && (a = e.split(".")), i = a.length)for (c = b; c && i--;)d = a.shift(), c = c[d]
        } catch (h) {
        }
        return c
        ...
        f.remove();
        return 5 !== e
    }, cell_width: !0, ajaxOptions: {}, from: function (f) {
        return new function (e, c) {
            "string" === typeof e && (e = b.data(e));
            var d = this, a = e, i = !0, f = !1, g = c, j = /[\$,%]/g, k = null, m = null, n = 0, s = !1, l = "", x = [], v = !0;
            if ("object" === typeof e &&
                e.push)0 < e.length && (v = "object" !== typeof e[0] ? !1 : !0); else throw"data provides is not an array";
            ...
            this._repeatCommand = function (a, b) {
                return null === k ? d : null !== a && null !== b ? k(a, b) : null === m || !v ? k(a) : k(m, a)
            };
            this._equals = function (a, b) {
                return 0 === d._compare(a, b,
                    1)
            };
            ...
            this._doSort = function (a, b) {
                var c = x[b].by, f = x[b].dir,
                    i = x[b].type, e = x[b].datefmt;
                if (b == x.length - 1)return d._getOrder(a, c, f, i, e);
                b++;
                for (var c = d._getGroup(a, c, f, i, e), f = [], h, i = 0; i < c.length; i++) {
                    h = d._doSort(c[i].items, b);
                    for (e = 0; e < h.length; e++)f.push(h[e])
                }
                return f
            };
            this._getOrder = function (a, c, f, e, h) {
                var g = [], k = [], m = "a" == f ? 1 : -1, n, s;
                void 0 === e && (e = "text");
                s = "float" == e || "number" == e || "currency" == e || "numeric" == e ? function (a) {
                    a = parseFloat(("" + a).replace(j, ""));
                    return isNaN(a) ? 0 : a
                } : "int" == e || "integer" == e ? function (a) {
                    return a ? parseFloat(("" + a).replace(j, "")) : 0
                } :
                    "date" == e || "datetime" == e ? function (a) {
                        return b.jgrid.parseDate(h, a).getTime()
                    } : b.isFunction(e) ? e : function (a) {
                        a = a ? b.trim("" + a) : "";
                        return i ? a : a.toLowerCase()
                    };
                b.each(a, function (a, d) {
                    n = "" !== c ? b.jgrid.getAccessor(d, c) : d;
                    void 0 === n && (n = "");
                    n = s(n, d);
                ...
                k.sort(function (a, b) {
                    a = a.vSort;
                    b = b.vSort;
                    return d._compare(a, b, m)
                });
                for (var e = 0, l = a.length; e < l;)f = k[e].index, g.push(a[f]), e++;
                return g
            };
            this._getGroup = function (a, c, e, f, i) {
                var h = [], g = null, j = null, k;
                b.each(d._getOrder(a, c, e, f, i), function (a, e) {
                    k = b.jgrid.getAccessor(e, c);
                    null == k && (k = "");
                    d._equals(j, k) || (j = k, null !== g && h.push(g), g = d._group(c, k));
                    g.items.push(e)
                });
                null !== g && h.push(g);
                return h
            ...
            this._compareValues = function (a, c, e, f, i) {
                var h;
                h = v ? "jQuery.jgrid.getAccessor(this,'" + c + "')" : "this";
                void 0 === e && (e = null);
                var g = e, k = void 0 === i.stype ? "text" : i.stype;
                if (null !== e)switch (k) {
                    case "int":
                    case "integer":
                    ...
                    case "datetime":
                        ...
                        break;
                    default:
                        h = d._getStr(h), g = d._getStr('"' + d._toStr(g) + '"')
                }
                d._append(h + " " + f + " " + g);
                d._setCommand(a, c);
                d._resetNegate();
            ...
            this.startsWith = function (a, c) {
                var e = null == c ? a : c, e = f ? b.trim(e.toString()).length : e.toString().length;
                v ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + e + ") == " + d._getStr('"' + d._toStr(c) + '"')) : (e = f ? b.trim(c.toString()).length : c.toString().length, d._append(d._getStr("this") + ".substr(0," + e + ") == " + d._getStr('"' + d._toStr(a) + '"')));
            ...
            this.endsWith = function (a, c) {
                var e = null == c ? a : c, e = f ? b.trim(e.toString()).length : e.toString().length;
                v ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + d._getStr("jQuery.jgrid.getAccessor(this,'" +
                    a + "')") + ".length-" + e + "," + e + ') == "' + d._toStr(c) + '"') : d._append(d._getStr("this") + ".substr(" + d._getStr("this") + '.length-"' + d._toStr(a) + '".length,"' + d._toStr(a) + '".length) == "' + d._toStr(a) + '"');
                d._setCommand(d.endsWith, a);
                d._resetNegate();
                return d
            };
            this.contains = function (a, b) {
                v ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + d._toStr(b) + '",0) > -1') : d._append(d._getStr("this") + '.indexOf("' + d._toStr(a) + '",0) > -1');
            ...
            this.groupBy =
                function (b, c, e, f) {
                    return!d._hasData() ? null : d._getGroup(a, b, c, e, f)
                };
            this.orderBy = function (a, c, e, f) {
                c = null == c ? "a" : b.trim(c.toString().toLowerCase());
                null == e && (e = "text");
                null == f && (f = "Y-m-d");
                if ("desc" == c || "descending" == c)c = "d";
                if ("asc" == c || "ascending" == c)c = "a";
                x.push({by: a, dir: c, type: e, datefmt: f});
                return d
            };
            return d
        }(f, null)
            ...
            if (!this.grid) {
                var d = b.extend(!0, {url: "", height: 150, page: 1, rowNum: 20, rowTotal: null, records: 0, pager: "", pgbuttons: !0, pginput: !0, colModel: [], rowList: [], colNames: [], sortorder: "asc", sortname: "", datatype: "xml", mtype: "GET", altRows: !1, selarrrow: [], savedRow: [], shrinkToFit: !0, xmlReader: {}, jsonReader: {}, subGrid: !1, subGridModel: [], reccount: 0, lastpage: 0,
                    ...
                    recordpos: "right", footerrow: !1, userDataOnFooter: !1, hoverrows: !0, altclass: "ui-priority-secondary", viewsortcols: [!1, "vertical", !0], resizeclass: "", autoencode: !1, remapColumns: [], ajaxGridOptions: {}, direction: "ltr", toppager: !1, headertitles: !1, scrollTimeout: 40, data: [], _index: {}, grouping: !1, groupingView: {groupField: [], groupOrder: [], groupText: [], groupColumnShow: [], groupSummary: [], showSummaryOnHide: !1, sortitems: [], sortnames: [], summary: [], summaryval: [], plusicon: "ui-icon-circlesmall-plus", minusicon: "ui-icon-circlesmall-minus",
                        displayField: []}, ignoreCase: !1, cmTemplate: {}, idPrefix: ""}, b.jgrid.defaults, f || {}), a = this, c = {headers: [], cols: [], footers: [], dragStart: function (c, e, f) {
                    ...
                    dragMove: function (a) {
                        ...
                        if (this.resizing) {
                            var c = this.resizing.idx,
                                e = this.headers[c].newWidth || this.headers[c].width, e = parseInt(e, 10);
                            this.resizing = !1;
                            ...
                            !0 === d.forceFit ? (e = this.headers[c + d.nv].newWidth || this.headers[c + d.nv].width, this.headers[c + d.nv].width = e, this.headers[c + d.nv].el.style.width = e + "px", this.cols[c + d.nv].style.width = e + "px", 0 < this.footers.length &&
                            ...
                            b.isFunction(d.resizeStop) && d.resizeStop.call(this, e, c)
                        }
                        this.curGbox = null;
                        ...
                        if (a) {
                            var e = b("table:first", c.bDiv), f, K;
                            if (e[0].rows.length)try {
                                K = (f = e[0].rows[1]) ? b(f).outerHeight() || c.prevRowHeight : c.prevRowHeight
                            } catch (h) {
                                K = c.prevRowHeight
                            }
                            if (K) {
                                ...
                                K *= g;
                                var z, F, q;
                                if (k < a && 0 >= j && (void 0 === d.lastpage || parseInt((k + f + K - 1) / K, 10) <= d.lastpage))F = parseInt((a -
                                    k + K - 1) / K, 10), 0 <= k || 2 > F || !0 === d.scroll ? (z = Math.round((k + f) / K) + 1, j = -1) : j = 1;
                                0 < j && (z = parseInt(f / K, 10) + 1, F = parseInt((f + a) / K, 10) + 2 - z, q = !0);
                                if (F && (!d.lastpage || !(z > d.lastpage || 1 == d.lastpage || z === d.page && z === d.lastpage)))c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, d.scrollTimeout) : (d.page = z, q && (c.selectionPreserver(e[0]), c.emptyRows.call(e[0], !1, !1)), c.populate(F))
                            }
                        }
                        ...
                        if (d.scroll) {
                            ...
                            b != c.scrollTop && (c.scrollTop = b, c.timer &&
                                clearTimeout(c.timer), c.timer = setTimeout(c.populateVisible, d.scrollTimeout))
                        }
                        c.hDiv.scrollLeft = c.bDiv.scrollLeft;
                        d.footerrow && (c.sDiv.scrollLeft = c.bDiv.scrollLeft);
                        a && a.stopPropagation()
                    }, selectionPreserver: function (a) {
                        var c = a.p, e = c.selrow, d = c.selarrrow ? b.makeArray(c.selarrrow) : null, f = a.grid.bDiv.scrollLeft, h = function () {
                            var g;
                            c.selrow = null;
                            c.selarrrow = [];
                            if (c.multiselect && d && 0 < d.length)for (g = 0; g < d.length; g++)d[g] != e && b(a).jqGrid("setSelection", d[g], !1, null);
                ...
                if ("TABLE" != this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    var e, g;
                    if (0 === this.p.colNames.length)for (e = 0; e < this.p.colModel.length; e++)this.p.colNames[e] = this.p.colModel[e].label ||
                        this.p.colModel[e].name;
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        var j = b("<div class='ui-jqgrid-view'></div>"), k, m = b.browser.msie ? !0 : !1;
                        ...
                        var n = b("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");
                        b(n).insertBefore(j).attr({id: "gbox_" + this.id,
                            dir: g});
                        b(j).appendTo(n).attr("id", "gview_" + this.id);
                        k = m && 6 >= b.browser.version ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>' : "";
                        b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").append(k).insertBefore(j);
                        ...
                        var s = function (a, b) {
                        ...
                        }, l = function (e, d, f, h, g, j) {
                            var k = a.p.colModel[e], ja = k.align, z = 'style="', F = k.classes, q = k.name, o = [];
                            ja && (z = z + ("text-align:" + ja + ";"));
                            k.hidden === true && (z = z + "display:none;");
                            if (d === 0)z = z + ("width: " + c.headers[e].width + "px;"); else if (k.cellattr && b.isFunction(k.cellattr))if ((e = k.cellattr.call(a, g, f, h, k, j)) && typeof e === "string") {
                                e = e.replace(/style/i, "style").replace(/title/i,
                                    "title");
                                if (e.indexOf("title") > -1)k.title = false;
                                e.indexOf("class") > -1 && (F = void 0);
                                o = e.split("style");
                                if (o.length === 2) {
                            ...
                            z = z + ((F !== void 0 ? ' class="' + F + '"' : "") + (k.title && f ? ' title="' + b.jgrid.stripHtml(f) + '"' : ""));
                            z = z + (' aria-describedby="' + a.p.id + "_" + q + '"');
                            return z + o[0]
                        }, x = function (c) {
                            return c == null || c === "" ? "&#160;" : a.p.autoencode ?
                                b.jgrid.htmlEncode(c) : "" + c
                        }, v = function (c, e, d, f, h) {
                            var g = a.p.colModel[d];
                            if (g.formatter !== void 0) {
                                c = "" + a.p.idPrefix !== "" ? b.jgrid.stripPref(a.p.idPrefix, c) : c;
                                c = {rowId: c, colModel: g, gid: a.p.id, pos: d};
                                e = b.isFunction(g.formatter) ? g.formatter.call(a, e, c, f, h) : b.fmatter ? b.fn.fmatter.call(a, g.formatter, e, c, f, h) : x(e)
                            } else e = x(e);
                            return e
                        }, Q = function (a, b, c, e, d, f) {
                            b = v(a, b, c, d, "add");
                            return'<td role="gridcell" ' + l(c, e, b, d, a, f) + ">" + b + "</td>"
                        }, I = function (b, c, e, d) {
                            d = '<input role="checkbox" type="checkbox" id="jqg_' +
                                a.p.id + "_" + b + '" class="cbox" name="jqg_' + a.p.id + "_" + b + '"' + (d ? 'checked="checked"' : "") + "/>";
                            return'<td role="gridcell" ' + l(c, e, "", null, b, true) + ">" + d + "</td>"
                        }, Z = function (a, b, c, e) {
                            ...
                            for (f = 0; f < a.p.colModel.length; f++) {
                                ...
                                if (c.name !== "cb" && c.name !== "subgrid" && c.name !== "rn") {
                                    e[d] = b == "local" ? c.name : b == "xml" || b === "xmlstring" ?
                                        c.xmlmap || c.name : c.jsonmap || c.name;
                                    d++
                                }
                            }
                            return e
                            ...
                            var c = a.p.data.length, e, d, f;
                            e = a.p.rownumbers === true ? 1 : 0;
                            d = a.p.multiselect === true ? 1 : 0;
                            f = a.p.subGrid === true ? 1 : 0;
                            e = a.p.keyIndex === false || a.p.loadonce === true ? a.p.localReader.id : a.p.colModel[a.p.keyIndex + d + f + e].name;
                            for (d = 0; d < c; d++) {
                            ...
                            var i = "-1", j = "", k, e = e ? "display:none;" :
                                "", d = "ui-widget-content jqgrow ui-row-" + a.p.direction + d + (h ? " ui-state-highlight" : ""), f = b.isFunction(a.p.rowattr) ? a.p.rowattr.call(a, f, g) : {};
                            ...
                            return'<tr role="row" id="' +
                                c + '" tabindex="' + i + '" class="' + d + '"' + (e === "" ? "" : ' style="' + e + '"') + j + ">"
                        }, $ = function (c, e, d, f, g) {
                            var h = new Date, i = a.p.datatype != "local" && a.p.loadonce || a.p.datatype == "xmlstring", j = a.p.xmlReader, k = a.p.datatype == "local" ? "local" : "xml";
                            if (i) {
                                a.p.data = [];
                                a.p._index = {};
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                var F = b(a), q, o, m = 0, r, D = a.p.multiselect === true ? 1 : 0, n = 0, s, l = a.p.rownumbers === true ? 1 : 0, v, p = [], y, B = {}, t, w, G = [],
                                    x = a.p.altRows === true ? " " + a.p.altclass : "", A;
                                if (a.p.subGrid === true) {
                                    n = 1;
                                    s = b.jgrid.getMethod("addSubGridCell")
                                }
                                j.repeatitems || (p = W(k));
                                v = a.p.keyIndex === false ? b.isFunction(j.id) ? j.id.call(a, c) : j.id : a.p.keyIndex;
                                if (p.length > 0 && !isNaN(v)) {
                                    a.p.remapColumns && a.p.remapColumns.length && (v = b.inArray(v, a.p.remapColumns));
                                    v = p[v]
                                }
                                k = ("" + v).indexOf("[") === -1 ? p.length ? function (a, c) {
                                    return b(v, a).text() || c
                                } : function (a, c) {
                                    return b(j.cell, a).eq(v).text() || c
                                } : function (a, b) {
                                    return a.getAttribute(v.replace(/[\[\]]/g, "")) ||
                                        b
                                };
                                a.p.userData = {};
                                ...
                                var V = c.length, u = 0, C = [], E = parseInt(a.p.rowNum,
                                    10), H = a.p.scroll ? b.jgrid.randId() : 1;
                                if (V > 0 && a.p.page <= 0)a.p.page = 1;
                                if (c && V) {
                                    g && (E = E * (g + 1));
                                    var g = b.isFunction(a.p.afterInsertRow), L = false, J;
                                    if (a.p.grouping) {
                                        L = a.p.groupingView.groupCollapse === true;
                                        J = b.jgrid.getMethod("groupingPrepare")
                                    }
                                    for (; u < V;) {
                                        t = c[u];
                                        w = k(t, H + u);
                                        ...
                                        var M = G.length;
                                        G.push("");
                                        l && G.push(Z(0, u, a.p.page, a.p.rowNum));
                                        D && G.push(I(w, l, u, false));
                                        n && G.push(s.call(F, D + l, u + d));
                                        if (j.repeatitems) {
                                            y || (y = X(D + n + l));
                                            var N = b.jgrid.getXmlData(t, j.cell,
                                                true);
                                            b.each(y, function (b) {
                                                var c = N[this];
                                                if (!c)return false;
                                                r = c.textContent || c.text;
                                                B[a.p.colModel[b + D + n + l].name] = r;
                                                G.push(Q(w, r, b + D + n + l, u + d, t, B))
                                            })
                                        } else for (q = 0; q < p.length; q++) {
                                            r = b.jgrid.getXmlData(t, p[q]);
                                            B[a.p.colModel[q + D + n + l].name] = r;
                                            G.push(Q(w, r, q + D + n + l, u + d, t, B))
                                        }
                                        G[M] = O(w, L, A, B, t, false);
                                        G.push("</tr>");
                                        if (a.p.grouping) {
                                            C = J.call(F, G, C, B, u);
                                            G = []
                                        ...
                                        if (a.p.gridview === false) {
                                            b("tbody:first", e).append(G.join(""));
                                            F.triggerHandler("jqGridAfterInsertRow",
                                                [w, B, t]);
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) {
                                        F.jqGrid("groupingRender", C, a.p.colModel.length);
                                        C = null
                                    } else a.p.treeGrid === true && o > 0 ? b(a.rows[o]).after(G.join("")) : b("tbody:first", e).append(G.join(""))
                                }
                                if (a.p.subGrid === true)try {
                                    F.jqGrid("addSubGrid", D + l)
                                } catch (S) {
                                }
                                a.p.totaltime = new Date - h;
                                if (m > 0 && a.p.records === 0)a.p.records = V;
                                G = null;
                                if (a.p.treeGrid === true)try {
                                    F.jqGrid("setTreeNode", o + 1, m + o + 1)
                                } catch (T) {
                                }
                                ...
                                if (i)for (; m < V;) {
                                    ...
                                    if (j.repeatitems) {
                                        y || (y = X(D + n + l));
                                        var P = b.jgrid.getXmlData(t, j.cell, true);
                                        b.each(y, function (b) {
                                            var c = P[this];
                                            if (!c)return false;
                                            r = c.textContent || c.text;
                            ...
                            if (c) {
                                ...
                                var k = b(a), m = 0, q, o, n = [], r, D = a.p.multiselect ? 1 :
                                    0, l = 0, s, v = a.p.rownumbers === true ? 1 : 0, p, u, y = {}, B, t, w = [], G = a.p.altRows === true ? " " + a.p.altclass : "", x;
                                ...
                                var A = parseInt(a.p.rowNum, 10), C = a.p.scroll ? b.jgrid.randId() : 1, E = false, H;
                                g && (A = A * (g + 1));
                                a.p.datatype === "local" && !a.p.deselectAfterSort && (E = true);
                                var L = b.isFunction(a.p.afterInsertRow), J = [], M = false, N;
                                if (a.p.grouping) {
                                ...
                                for (; c < p;) {
                                    ...
                                    q = d === 1 ? 0 : d;
                                    x = (q + c) % 2 == 1 ? G : "";
                                    E && (H = a.p.multiselect ? b.inArray(t, a.p.selarrrow) !== -1 : t === a.p.selrow);
                                    var P = w.length;
                                    w.push("");
                                    v && w.push(Z(0, c, a.p.page, a.p.rowNum));
                                    D && w.push(I(t, v, c, H));
                                    l && w.push(s.call(k, D + v, c + d));
                                    if (h.repeatitems) {
                                        h.cell && (g = b.jgrid.getAccessor(g, h.cell));
                                        r || (r = X(D + l + v))
                                    }
                                    for (o = 0; o < r.length; o++) {
                                        q = b.jgrid.getAccessor(g, r[o]);
                                        y[a.p.colModel[o + D + l + v].name] = q;
                                        w.push(Q(t, q, o + D + l + v, c +
                                            d, g, y))
                                    }
                                    w[P] = O(t, M, x, y, g, H);
                                    w.push("</tr>");
                                    ...
                                    if (a.p.gridview === false) {
                                        ...
                                        k.triggerHandler("jqGridAfterInsertRow", [t, y, g]);
                                        L && a.p.afterInsertRow.call(a, t, y, g);
                                        w = []
                                    }
                                    y = {};
                                    m++;
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    a.p.grouping ? k.jqGrid("groupingRender", J, a.p.colModel.length) : a.p.treeGrid ===
                                        true && B > 0 ? b(a.rows[B]).after(w.join("")) : b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(w.join(""))
                                }
                                if (a.p.subGrid === true)try {
                                    k.jqGrid("addSubGrid", D + v)
                                } catch (S) {
                                }
                                a.p.totaltime = new Date - e;
                                if (m > 0 && a.p.records === 0)a.p.records = p;
                                if (a.p.treeGrid === true)try {
                                    k.jqGrid("setTreeNode", B + 1, m + B + 1)
                                } catch (T) {
                                }
                                if (!a.p.treeGrid && !a.p.scroll)a.grid.bDiv.scrollTop = 0;
                                a.p.reccount = m;
                                ...
                                if (j) {
                                    a.p.records = p;
                                    a.p.lastpage = Math.ceil(p / A)
                                }
                                f ||
                                a.updatepager(false, true);
                                if (j)for (; m < p && u[m];) {
                                    g = u[m];
                                    t = b.jgrid.getAccessor(g, i);
                                    if (t === void 0) {
                            ...
                            function c(e) {
                                ...
                                if (e.groups != null) {
                                    (h = e.groups.length &&
                                        e.groupOp.toString().toUpperCase() === "OR") && r.orBegin();
                                ...
                                if (e.rules != null) {
                                    if (d > 0) {
                                        h = r.select();
                                        r = b.jgrid.from(h);
                                        a.p.ignoreCase && (r = r.ignoreCase())
                                    }
                                    try {
                                        (i = e.rules.length && e.groupOp.toString().toUpperCase() === "OR") && r.orBegin();
                                        for (g = 0; g < e.rules.length; g++) {
                                            U = e.rules[g];
                                            j = e.groupOp.toString().toUpperCase();
                                            if (n[U.op] && U.field) {
                                                d > 0 && j && j === "OR" && (r = r.or());
                                                r = n[U.op](r, j)(U.field, U.data, f[U.field])
                                            }
                                            d++
                                        }
                                        i &&
                            ...
                            var e, d = false, f = {}, g = [], h = [], i, j, k;
                            if (b.isArray(a.p.data)) {
                                var m = a.p.grouping ? a.p.groupingView : false, q, o;
                                b.each(a.p.colModel, function () {
                                    ...
                                    if (j == "date" || j == "datetime") {
                                        if (this.formatter && typeof this.formatter === "string" && this.formatter == "date") {
                                            ...
                                            k = this.datefmt || "Y-m-d";
                                        f[this.name] = {stype: j, srcfmt: i, newfmt: k}
                                    } else f[this.name] = {stype: j, srcfmt: "", newfmt: ""};
                                    if (a.p.grouping) {
                                        o = 0;
                                        for (q = m.groupField.length; o < q; o++)if (this.name == m.groupField[o]) {
                                            var c = this.name;
                                ...
                                if (a.p.treeGrid)b(a).jqGrid("SortTree", e, a.p.sortorder, f[e].stype, f[e].srcfmt); else {
                                    var n = {eq: function (a) {
                                        return a.equals
                                    }, ne: function (a) {
                                        return a.notEquals
                                    ...
                                    a.p.ignoreCase && (r = r.ignoreCase());
                                    if (a.p.search === true) {
                                        var l = a.p.postData.filters;
                                        if (l) {
                                            typeof l === "string" && (l = b.jgrid.parse(l));
                                            c(l)
                                        } else try {
                                            r = n[a.p.postData.searchOper](r)(a.p.postData.searchField, a.p.postData.searchString, f[a.p.postData.searchField])
                                        } catch (v) {
                                        }
                                    }
                                    if (a.p.grouping)for (o = 0; o < q; o++)r.orderBy(h[o], m.groupOrder[o], g[o].stype,
                                        g[o].srcfmt);
                                    e && a.p.sortorder && d && (a.p.sortorder.toUpperCase() == "DESC" ? r.orderBy(a.p.sortname, "d", f[e].stype, f[e].srcfmt) : r.orderBy(a.p.sortname, "a", f[e].stype, f[e].srcfmt));
                                    var l = r.select(), p = parseInt(a.p.rowNum, 10), s = l.length, u = parseInt(a.p.page, 10), x = Math.ceil(s / p), y = {}, l = l.slice((u - 1) * p, u * p), f = r = null;
                                    y[a.p.localReader.total] = x;
                                    y[a.p.localReader.page] = u;
                                    y[a.p.localReader.records] = s;
                                    y[a.p.localReader.root] = l;
                                    y[a.p.localReader.userdata] = a.p.userData;
                                    l = null;
                                    return y
                                }
                            }
                            ...
                            if (!a.grid.hDiv.loading) {
                                var e = a.p.scroll && c === false, d = {}, f, g = a.p.prmNames;
                                if (a.p.page <=
                                    0)a.p.page = 1;
                                ...
                                if (a.p.grouping) {
                                    ...
                                    var k = a.p.groupingView, m, q = "";
                                    for (m = 0; m < k.groupField.length; m++) {
                                        var o = k.groupField[m];
                                        b.each(a.p.colModel, function (a, b) {
                                            if (b.name == o && b.index)o = b.index
                                        });
                                        q = q + (o + " " + k.groupOrder[m] + ", ")
                                    }
                                    d[g.sort] = q + d[g.sort]
                                }
                                b.extend(a.p.postData, d);
                                var l = !a.p.scroll ? 1 : a.rows.length - 1, d = b(a).triggerHandler("jqGridBeforeRequest");
                                if (!(d === false || d === "stop"))if (b.isFunction(a.p.datatype))a.p.datatype.call(a,
                                    a.p.postData, "load_" + a.p.id); else {
                                    ...
                                    switch (f) {
                                        ...
                                        case "xml":
                                        case "script":
                                            b.ajax(b.extend({url: a.p.url, type: a.p.mtype, dataType: f, data: b.isFunction(a.p.serializeGridData) ? a.p.serializeGridData.call(a, a.p.postData) : a.p.postData, success: function (d, g, h) {
                                                    if (b.isFunction(a.p.beforeProcessing) && a.p.beforeProcessing.call(a, d, g, h) === false)S(); else {
                                                        f === "xml" ?
                                                            $(d, a.grid.bDiv, l, c > 1, j) : aa(d, a.grid.bDiv, l, c > 1, j);
                            ...
                            if (a.p.frozenColumns && a.p.id + "_frozen")b("#cb_" + b.jgrid.jqID(a.p.id), a.grid.fhDiv)[a.p.useProp ? "prop" : "attr"]("checked",
                                c)
                        };
                        k = function (c, e) {
                            var d = "", f = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", h = "", i, j, k, m, l = function (c) {
                                var e;
                            ...
                            }, c = c.substr(1), e = e + ("_" + c);
                            i = "pg_" + c;
                            j = c + "_left";
                            k = c + "_center";
                            m = c + "_right";
                            b("#" + b.jgrid.jqID(c)).append("<div id='" + i + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" +
                                j + "' align='left'></td><td id='" + k + "' align='center' style='white-space:pre;'></td><td id='" + m + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                            ...
                            g == "rtl" && (f = f + h);
                            a.p.pginput === true && (d = "<td dir='" +
                                g + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(c) + "'></span>") + "</td>");
                            if (a.p.pgbuttons === true) {
                                ...
                                f = f + (d !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + d + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" : "") + ("<td id='" + j[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-next'></span></td>");
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + b.jgrid.jqID(e) + ", #prev" + b.jgrid.jqID(e) + ", #next" + b.jgrid.jqID(e) + ", #last" + b.jgrid.jqID(e)).click(function () {
                                    var b = s(a.p.page, 1), c = s(a.p.lastpage, 1), d = false, f = true, g = true, h = true, i = true;
                        ...
                        var ka = function (c, e, d, f) {
                            if (a.p.colModel[e].sortable && !(a.p.savedRow.length > 0)) {
                                if (!d) {
                                    ...
                                    } else a.p.sortorder = a.p.colModel[e].firstsortorder || "asc";
                                    a.p.page = 1
                                }
                                if (f) {
                                ...
                                a.p.sortname = a.p.colModel[e].index || c;
                                d = a.p.sortorder;
                            ...
                            var e, d = {}, f = b.jgrid.cell_width ? 0 : a.p.cellLayout;
                            for (e = d[0] = d[1] = d[2] = 0; e <= c; e++)a.p.colModel[e].hidden === false && (d[0] = d[0] + (a.p.colModel[e].width + f));
                            a.p.direction == "rtl" && (d[0] = a.p.width -
                                d[0]);
                            d[0] = d[0] - a.grid.bDiv.scrollLeft;
                            b(a.grid.cDiv).is(":visible") && (d[1] = d[1] + (b(a.grid.cDiv).height() + parseInt(b(a.grid.cDiv).css("padding-top"), 10) + parseInt(b(a.grid.cDiv).css("padding-bottom"), 10)));
                            ...
                            a.p.toppager && (d[1] = d[1] + (b(a.grid.topDiv).height() + parseInt(b(a.grid.topDiv).css("border-bottom-width"),
                                10)));
                        ...
                        this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({name: "cb", width: b.jgrid.cell_width ?
                            a.p.multiselectWidth + a.p.cellLayout : a.p.multiselectWidth, sortable: !1, resizable: !1, hidedlg: !0, search: !1, align: "center", fixed: !0}));
                        ...
                        a.p.xmlReader = b.extend(!0, {root: "rows", row: "row", page: "rows>page", total: "rows>total", records: "rows>records", repeatitems: !0, cell: "cell", id: "[id]", userdata: "userdata", subgrid: {root: "rows", row: "row",
                        ...
                        a.p.scroll && (a.p.pgbuttons = !1, a.p.pginput = !1,
                            a.p.rowList = []);
                        a.p.data.length && N();
                        var C = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", ma, J, ea, ba, fa, A, p, T;
                        J = T = "";
                        if (!0 === a.p.shrinkToFit && !0 === a.p.forceFit)for (e = a.p.colModel.length - 1; 0 <= e; e--)if (!a.p.colModel[e].hidden) {
                            a.p.colModel[e].resizable = !1;
                            break
                        }
                        "horizontal" == a.p.viewsortcols[1] && (T = " ui-i-asc", J = " ui-i-desc");
                        ma = m ? "class='ui-th-div-ie'" : "";
                        T = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + T + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" +
                            g + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + J + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>");
                        for (e = 0; e < this.p.colNames.length; e++)J = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[e]) + '"' : "", C += "<th id='" + a.p.id + "_" + a.p.colModel[e].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + g + "'" + J + ">", J = a.p.colModel[e].index || a.p.colModel[e].name, C += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[e].name + "' " + ma + ">" + a.p.colNames[e],
                            a.p.colModel[e].width = a.p.colModel[e].width ? parseInt(a.p.colModel[e].width, 10) : 150, "boolean" !== typeof a.p.colModel[e].title && (a.p.colModel[e].title = !0), J == a.p.sortname && (a.p.lastsort = e), C += T + "</div></th>";
                        T = null;
                        b(this).append(C + "</tr></thead>");
                        ...
                        if (this.p.multiselect) {
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
                                ...
                                b(a).triggerHandler("jqGridSelectAll", [P ? a.p.selarrrow : ga, P]);
                                b.isFunction(a.p.onSelectAll) && a.p.onSelectAll.call(a, P ? a.p.selarrrow : ga, P)
                            })
                        }
                        !0 === a.p.autowidth && (C = b(n).innerWidth(), a.p.width = 0 < C ? C : "nw");
                        (function () {
                            var d = 0, e = b.jgrid.cell_width ? 0 : s(a.p.cellLayout, 0), f = 0, g, h = s(a.p.scrollOffset, 0), j, k = false, m, l = 0, n = 0, q;
                            b.each(a.p.colModel, function () {
                                ...
                                this.widthOrg = j = s(this.width, 0);
                                if (this.hidden === false) {
                                    d = d + (j + e);
                                    this.fixed ? l = l + (j + e) : f++;
                                    n++
                                }
                            });
                            ...
                            if (a.p.shrinkToFit === true && f > 0) {
                                ...
                                q = 0;
                                k ? c.width - l - (d + e * f) !== h && (q = c.width - l - (d + e * f) - h) : !k && Math.abs(c.width - l - (d + e * f)) !== 1 && (q = c.width - l - (d + e * f));
                                a.p.colModel[g].width = a.p.colModel[g].width + q;
                                a.p.tblwidth = d + q + e * f + l;
                        ...
                        b(n).css("width", c.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" +
                            a.p.id + "'>&#160;</div>");
                        b(j).css("width", c.width + "px");
                        var C = b("thead:first", a).get(0), M = "";
                        a.p.footerrow && (M += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + g + "'>");
                        var j = b("tr:first", C), Y = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                        a.p.disableClick = !1;
                        b("th", j).each(function (d) {
                            ea = a.p.colModel[d].width;
                            if (a.p.colModel[d].resizable === void 0)a.p.colModel[d].resizable =
                                true;
                            if (a.p.colModel[d].resizable) {
                                ba = document.createElement("span");
                                b(ba).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + g);
                            ...
                            if (typeof fa !==
                                "boolean")fa = a.p.colModel[d].sortable = true;
                            ...
                            a.p.footerrow && (M = M + ("<td role='gridcell' " + l(d, 0,
                                "", null, "", false) + ">&#160;</td>"))
                        ...
                        a.p.footerrow && (M += "</tr></tbody></table>");
                        Y += "</tr>";
                        this.appendChild(document.createElement("tbody"));
                        b(this).addClass("ui-jqgrid-btable").append(Y);
                        var Y = null, j = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(C),
                            E = a.p.caption && !0 === a.p.hiddengrid ? !0 : !1;
                        e = b("<div class='ui-jqgrid-hbox" + ("rtl" == g ? "-rtl" : "") + "'></div>");
                        C = null;
                        ...
                        j = null;
                        E && b(c.hDiv).hide();
                        a.p.pager && ("string" === typeof a.p.pager ? "#" != a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({width: c.width + "px"}).appendTo(n).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"),
                            E && b(a.p.pager).hide(), k(a.p.pager, ""));
                        ...
                        b(a).before(c.hDiv).click(function (c) {
                            ...
                            if (b(p).length === 0 || p[0].className.indexOf("ui-state-disabled") > -1 || (b(A, a).closest("table.ui-jqgrid-btable").attr("id") ||
                                "").replace("_frozen", "") !== a.id)return this;
                            var d = b(A).hasClass("cbox"), e = b(a).triggerHandler("jqGridBeforeSelectRow", [p[0].id, c]);
                            ...
                            if (!(A.tagName == "A" || (A.tagName == "INPUT" || A.tagName == "TEXTAREA" || A.tagName == "OPTION" || A.tagName == "SELECT") && !d) && e === true) {
                                u = p[0].id;
                                H = b.jgrid.getCellIndex(A);
                                ha = b(A).closest("td,th").html();
                                b(a).triggerHandler("jqGridCellSelect", [u, H, ha, c]);
                                b.isFunction(a.p.onCellSelect) &&
                                a.p.onCellSelect.call(a, u, H, ha, c);
                                if (a.p.cellEdit === true)if (a.p.multiselect && d)b(a).jqGrid("setSelection", u, true, c); else {
                                    u = p[0].rowIndex;
                                    try {
                                        b(a).jqGrid("editCell", u, H, true)
                                    } catch (f) {
                                    }
                                } else if (a.p.multikey)if (c[a.p.multikey])b(a).jqGrid("setSelection", u, true, c); else {
                                    if (a.p.multiselect && d) {
                                        d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + u).is(":checked");
                                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + u)[a.p.useProp ? "prop" : "attr"]("checked", d)
                                    }
                                } else {
                                    if (a.p.multiselect && a.p.multiboxonly && !d) {
                                        var g = a.p.frozenColumns ? a.p.id +
                                            "_frozen" : "";
                                    ...
                                    b(a).jqGrid("setSelection", u, true, c)
                                }
                            }
                        }).bind("reloadGrid",function (c, d) {
                                if (a.p.treeGrid ===
                                    true)a.p.datatype = a.p.treedatatype;
                                ...
                                a.p.scroll && R.call(a, true, false);
                                if (d && d.page) {
                                    var e = d.page;
                                ...
                                if (b(p).length !== 0) {
                                    u = p[0].rowIndex;
                                    H = b.jgrid.getCellIndex(A);
                                    b(a).triggerHandler("jqGridDblClickRow", [b(p).attr("id"), u, H, c]);
                                    b.isFunction(this.p.ondblClickRow) && a.p.ondblClickRow.call(a, b(p).attr("id"), u, H, c)
                                }
                                ...
                                if (b(p).length !== 0) {
                                    a.p.multiselect ||
                                    b(a).jqGrid("setSelection", p[0].id, true, c);
                                    u = p[0].rowIndex;
                                    H = b.jgrid.getCellIndex(A);
                                    b(a).triggerHandler("jqGridRightClickRow", [b(p).attr("id"), u, H, c]);
                                    b.isFunction(this.p.onRightClickRow) && a.p.onRightClickRow.call(a, b(p).attr("id"), u, H, c)
                                }
                            });
                        c.bDiv = document.createElement("div");
                        m && "auto" === ("" + a.p.height).toLowerCase() && (a.p.height = "100%");
                        b(c.bDiv).append(b('<div style="position:relative;' + (m && 8 > b.browser.version ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height: a.p.height +
                            (isNaN(a.p.height) ? "" : "px"), width: c.width + "px"}).scroll(c.scrollGrid);
                        b("table:first", c.bDiv).css({width: a.p.tblwidth + "px"});
                        m ? (2 == b("tbody", this).length && b("tbody:gt(0)", this).remove(), a.p.multikey && b(c.bDiv).bind("selectstart", function () {
                            return false
                        ...
                        a.p.toolbar[0] && (c.uDiv = document.createElement("div"), "top" == a.p.toolbar[1] ? b(c.uDiv).insertBefore(c.hDiv) : "bottom" == a.p.toolbar[1] &&
                            b(c.uDiv).insertAfter(c.hDiv), "both" == a.p.toolbar[1] ? (c.ubDiv = document.createElement("div"), b(c.uDiv).insertBefore(c.hDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), b(c.ubDiv).insertAfter(c.hDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id), E && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), E && b(c.uDiv).hide());
                        a.p.toppager && (a.p.toppager = b.jgrid.jqID(a.p.id) + "_toppager", c.topDiv = b("<div id='" +
                            a.p.toppager + "'></div>")[0], a.p.toppager = "#" + a.p.toppager, b(c.topDiv).insertBefore(c.hDiv).addClass("ui-state-default ui-jqgrid-toppager").width(c.width), k(a.p.toppager, "_t"));
                        a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], e = b("<div class='ui-jqgrid-hbox" + ("rtl" == g ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(e).insertAfter(c.hDiv).width(c.width), b(e).append(M), c.footers = b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"),
                            E && b(c.sDiv).hide());
                        e = null;
                        if (a.p.caption) {
                            var qa = a.p.datatype;
                            !0 === a.p.hidegrid && (b(".ui-jqgrid-titlebar-close", c.cDiv).click(function (d) {
                                ...
                                a.p.gridstate == "visible" ? b(f, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp("fast", function () {
                                    ...
                                    if (g === 0) {
                                        ...
                                        e && (E || a.p.onHeaderClick.call(a, a.p.gridstate, d))
                                    }
                                ...
                                return false
                            }), E && (a.p.datatype = "local", b(".ui-jqgrid-titlebar-close", c.cDiv).trigger("click")))
                        } else b(c.cDiv).hide();
    ...
    b.jgrid.extend({getGridParam: function (b) {
        var e = this[0];
        return!e || !e.grid ? void 0 : !b ? e.p : void 0 !== e.p[b] ? e.p[b] : null
        ...
        var f = [], e = 0, c, d = 0;
        this.each(function () {
            if ((c = this.rows.length) && 0 < c)for (; e < c;)b(this.rows[e]).hasClass("jqgrow") &&
                (f[d] = this.rows[e].id, d++), e++
        });
        return f
        ...
        return this.each(function () {
            ...
            if (void 0 !== f && (e = !1 === e ? !1 : !0, (a = this.rows.namedItem("" + f)) && a.className && !(-1 < a.className.indexOf("ui-state-disabled"))))(!0 === this.p.scrollrows && (i = this.rows.namedItem(f).rowIndex, 0 <= i && (d = b(this.grid.bDiv)[0].clientHeight, h = b(this.grid.bDiv)[0].scrollTop, g = b(this.rows[i]).position().top, i = this.rows[i].clientHeight, g + i >= d + h ? b(this.grid.bDiv)[0].scrollTop = g - (d + h) + i + h : g < d + h && g < h && (b(this.grid.bDiv)[0].scrollTop =
                ...
                e && this.p.onSelectRow.call(this, a.id, d, c))
        })
    }, resetSelection: function (f) {
        return this.each(function () {
            var e = this, c, d, a;
            !0 === e.p.frozenColumns && (a = e.p.id + "_frozen");
            if (void 0 !== f) {
                ...
                if (e.p.multiselect) {
                    b("#jqg_" + b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(e.p.id))[e.p.useProp ?
                        "prop" : "attr"]("checked", !1);
                    if (a)b("#jqg_" + b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(a))[e.p.useProp ? "prop" : "attr"]("checked", !1);
                    e.setHeadCheckBox(!1)
                }
                d = null
                ...
                a && (b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), b("#jqg_" +
                    b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(a))[e.p.useProp ? "prop" : "attr"]("checked", !1))
            }), e.setHeadCheckBox(!1), e.p.selarrrow = []) : e.p.selrow && (b("#" + b.jgrid.jqID(e.p.id) + " tbody:first tr#" + b.jgrid.jqID(e.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"), a && b("#" + b.jgrid.jqID(e.p.selrow), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), e.p.selrow = null);
            !0 === e.p.cellEdit && 0 <= parseInt(e.p.iCol, 10) && 0 <= parseInt(e.p.iRow, 10) && (b("td:eq(" + e.p.iCol + ")", e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight"),
                b(e.rows[e.p.iRow]).removeClass("selected-row ui-state-hover"));
            e.p.savedRow = []
        })
        ...
        this.each(function () {
            var h = this, g, j;
            if (void 0 === f)d = !0, c = [], a = h.rows.length; else {
                j = h.rows.namedItem(f);
                if (!j)return e;
                a = 2
            }
            for (; i < a;)d && (j = h.rows[i]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function (a) {
                g = h.p.colModel[a].name;
                if ("cb" !== g && "subgrid" !== g && "rn" !== g)if (!0 === h.p.treeGrid && g == h.p.ExpandColumn)e[g] = b.jgrid.htmlDecode(b("span:first", this).html());
                else try {
                        e[g] = b.unformat.call(h, this, {rowId: j.id, colModel: h.p.colModel[a]}, a)
                    } catch (c) {
                        e[g] = b.jgrid.htmlDecode(b(this).html())
                    }
            }), d && (c.push(e), e = {})), i++
        });
        return c || e
        ...
        this.each(function () {
            ...
            e = !0;
            this.p.multiselect && (d = b.inArray(f, this.p.selarrrow), -1 != d && this.p.selarrrow.splice(d, 1));
            this.p.selrow = this.p.multiselect && 0 < this.p.selarrrow.length ? this.p.selarrrow[this.p.selarrrow.length -
                1] : null;
        ...
        this.each(function () {
            ...
            var h = this, g, j, k = typeof c, m = {};
            j = h.rows.namedItem(f);
            if (!j)return!1;
            if (e)try {
                if (b(this.p.colModel).each(function (a) {
                    d = this.name;
                    void 0 !== e[d] && (m[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ? b.unformat.date.call(h, e[d], this) : e[d], g = h.formatter(f, e[d], a, e, "edit"), i = this.title ? {title: b.jgrid.stripHtml(g)} : {}, !0 === h.p.treeGrid && d == h.p.ExpandColumn ? b("td[role='gridcell']:eq(" + a + ") > span:first", j).html(g).attr(i) : b("td[role='gridcell']:eq(" + a + ")", j).html(g).attr(i))
                }), "local" == h.p.datatype) {
                    var n = b.jgrid.stripPref(h.p.idPrefix, f), s = h.p._index[n], l;
                    if (h.p.treeGrid)for (l in h.p.treeReader)h.p.treeReader.hasOwnProperty(l) && delete m[h.p.treeReader[l]];
                    void 0 !== s && (h.p.data[s] = b.extend(!0, h.p.data[s], m));
                    m = null
                }
            } catch (x) {
                a = !1
        ...
        c || (c = "last");
        var a = !1, i, h, g, j, k, m, n, s, l = "", x, v, Q, I, Z, W;
        e && (b.isArray(e) ? (x = !0, c = "last", v = f) : (e = [e], x = !1), this.each(function () {
            var X = e.length;
            ...
            if (!x)if (f !== void 0)f =
                ...
                if (this.p.keyIndex !== false) {
                    v = this.p.colModel[this.p.keyIndex + g + j + k].name;
                    e[0][v] !== void 0 && (f = e[0][v])
                }
            }
            Q = this.p.altclass;
            for (var R = 0, N = "", O = {}, $ = b.isFunction(this.p.afterInsertRow) ? true : false; R < X;) {
                I = e[R];
                h = [];
                if (x) {
                    try {
                    ...
                    N = this.p.altRows === true ? (this.rows.length - 1) % 2 === 0 ? Q : "" : ""
                }
                W = f;
                f = this.p.idPrefix + f;
                if (k) {
                    l = this.formatCol(0, 1, "", null, f, true);
                    h[h.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' +
                        l + ">0</td>"
                }
                if (g) {
                    s = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + f + '" class="cbox"/>';
                    l = this.formatCol(k, 1, "", null, f, true);
                    h[h.length] = '<td role="gridcell" ' + l + ">" + s + "</td>"
                }
                ...
                for (n = g + j + k; n < this.p.colModel.length; n++) {
                    ...
                    i = Z.name;
                    O[i] = I[i];
                    s = this.formatter(f, b.jgrid.getAccessor(I, i), n, I);
                    l = this.formatCol(n, 1, s, I, f, O);
                    h[h.length] = '<td role="gridcell" ' + l + ">" + s + "</td>"
                }
                h.unshift(this.constructTr(f, false, N, O, I,
                    false));
                h[h.length] = "</tr>";
                if (this.rows.length === 0)b("table:first", this.grid.bDiv).append(h.join("")); else switch (c) {
                    case "last":
                    ...
                    case "first":
                        ...
                        break;
                    case "after":
                        (m = this.rows.namedItem(d)) && (b(this.rows[m.rowIndex + 1]).hasClass("ui-subgrid") ? b(this.rows[m.rowIndex + 1]).after(h) : b(m).after(h.join("")));
                        m++;
                        break;
                    case "before":
                        if (m = this.rows.namedItem(d)) {
                            b(m).before(h.join(""));
                            m = m.rowIndex
                        }
                        m--
                ...
                this.p.subGrid ===
                    true && b(this).jqGrid("addSubGrid", g + k, m);
                this.p.records++;
                this.p.reccount++;
                b(this).triggerHandler("jqGridAfterInsertRow", [f, I, I]);
                $ && this.p.afterInsertRow.call(this, f, I, I);
                R++;
                if (this.p.datatype == "local") {
                    O[this.p.localReader.id] = W;
                    this.p._index[W] = this.p.data.length;
                    this.p.data.push(O);
                    O = {}
                }
            }
            this.p.altRows === true && !x && (c == "last" ? (this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(Q) : b(this.rows).each(function (a) {
                a % 2 == 1 ? b(this).addClass(Q) : b(this).removeClass(Q)
            }));
        ...
        this.each(function () {
            ...
            b(this.p.colModel).each(function (d) {
                a = this.name;
                "set" == f ? void 0 !== e[a] && (k = c ? j.formatter("", e[a], d, e, "edit") : e[a], g = this.title ? {title: b.jgrid.stripHtml(k)} : {}, b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(k).attr(g),
                    i = !0) : "get" == f && (h[a] = b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html())
            })
        });
        return"get" == f ? h : i
    }, showHideCol: function (f, e) {
        return this.each(function () {
            var c = this, d = !1, a = b.jgrid.cell_width ? 0 : c.p.cellLayout, i;
            if (c.grid) {
                "string" === typeof f && (f = [f]);
                e = "none" != e ? "" : "none";
                var h = "" === e ? !0 : !1, g = c.p.groupHeader && ("object" === typeof c.p.groupHeader || b.isFunction(c.p.groupHeader));
                ...
                b(this.p.colModel).each(function (g) {
                    if (-1 !== b.inArray(this.name, f) && this.hidden === h) {
                        ...
                        b("tr", c.grid.hDiv).each(function () {
                            b(this.cells[g]).css("display", e)
                        });
                        b(c.rows).each(function () {
                            b(this).hasClass("jqgroup") || b(this.cells[g]).css("display", e)
                        });
                        c.p.footerrow && b("tr.footrow td:eq(" + g + ")", c.grid.sDiv).css("display", e);
                        i = parseInt(this.width, 10);
                        c.p.tblwidth = "none" === e ? c.p.tblwidth - (i + a) : c.p.tblwidth + (i + a);
                        this.hidden = !h;
                        d = !0;
                        b(c).triggerHandler("jqGridShowHideCol", [h, this.name, g])
                    }
                });
                !0 === d && (!0 === c.p.shrinkToFit && !isNaN(c.p.height) && (c.p.tblwidth +=
        ...
        e && a(b("#" + b.jgrid.jqID(i.p.id) + " tbody:first"), ".jqgfirstrow, tr.jqgrow, tr.jqfoot");
        i.p.footerrow && a(b("tbody:first", i.grid.sDiv));
        i.p.remapColumns && (i.p.remapColumns.length ? d(i.p.remapColumns) : i.p.remapColumns = b.makeArray(f));
        i.p.lastsort = b.inArray(i.p.lastsort, f);
        i.p.treeGrid && (i.p.expColInd =
            b.inArray(i.p.expColInd, f));
        b(i).triggerHandler("jqGridRemapColumns", [f, e, c])
    }, setGridWidth: function (f, e) {
        return this.each(function () {
            if (this.grid) {
                var c = this, d, a = 0, i = b.jgrid.cell_width ? 0 : c.p.cellLayout, h, g = 0, j = !1, k = c.p.scrollOffset, m, n = 0, s = 0, l;
                ...
                if (!isNaN(f)) {
                    ...
                    if (!0 === e) {
                        ...
                        m = f - i * g - n;
                        if (!isNaN(c.p.height) &&
                            (b(c.grid.bDiv)[0].clientHeight < b(c.grid.bDiv)[0].scrollHeight || 1 === c.rows.length))j = !0, m -= k;
                        var a = 0, x = 0 < c.grid.cols.length;
                        b.each(c.p.colModel, function (b) {
                            if (this.hidden === false && !this.fixed) {
                                d = this.widthOrg;
                                d = Math.round(m * d / (c.p.tblwidth - i * g - n));
                                if (!(d < 0)) {
                                    this.width = d;
                                    a = a + d;
                                    ...
                                    if (x)c.grid.cols[b].style.width = d + "px";
                                    h = b
                                }
                            }
                        });
                        if (!h)return;
                        l = 0;
                        j ? f - n - (a + i * g) !== k && (l = f - n - (a + i * g) - k) : 1 !==
                            Math.abs(f - n - (a + i * g)) && (l = f - n - (a + i * g));
                        c.p.colModel[h].width += l;
                        c.p.tblwidth = a + l + i * g + n;
                        c.p.tblwidth > f ? (j = c.p.tblwidth - parseInt(f, 10), c.p.tblwidth = f, d = c.p.colModel[h].width -= j) : d = c.p.colModel[h].width;
                        c.grid.headers[h].width = d;
                        c.grid.headers[h].el.style.width = d + "px";
                        x && (c.grid.cols[h].style.width = d + "px");
                        c.p.footerrow && (c.grid.footers[h].style.width = d + "px")
                    }
                    c.p.tblwidth && (b("table:first", c.grid.bDiv).css("width", c.p.tblwidth + "px"), b("table:first", c.grid.hDiv).css("width", c.p.tblwidth + "px"), c.grid.hDiv.scrollLeft =
                        c.grid.bDiv.scrollLeft, c.p.footerrow && b("table:first", c.grid.sDiv).css("width", c.p.tblwidth + "px"))
                }
            }
        })
        ...
        return this.each(function () {
            ...
            if (this.grid && void 0 !== f && (b(this.p.colModel).each(function (b) {
                ...
                if (e) {
                    var h = b(".s-ico", i);
                    b("[id^=jqgh_]", i).empty().html(e).append(h);
                    this.p.colNames[a] = e
                }
                c && ("string" === typeof c ? b(i).addClass(c) : b(i).css(c));
                "object" === typeof d && b(i).attr(d)
            }
        })
    }, setCell: function (f, e, c, d, a, i) {
        return this.each(function () {
            var h =
                -1, g, j;
            if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {
                if (this.name == e)return h = a, !1
            }) : h = parseInt(e, 10), 0 <= h && (g = this.rows.namedItem(f)))) {
                var k = b("td:eq(" + h + ")", g);
                if ("" !== c || !0 === i)g = this.formatter(f, c, h, g, "edit"), j = this.p.colModel[h].title ? {title: b.jgrid.stripHtml(g)} : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(g).attr(j) : b(k).html(g).attr(j), "local" == this.p.datatype && (g = this.p.colModel[h], c = g.formatter && "string" === typeof g.formatter && "date" == g.formatter ? b.unformat.date.call(this,
                    c, g) : c, j = this.p._index[f], void 0 !== j && (this.p.data[j][g.name] = c));
                "string" === typeof d ? b(k).addClass(d) : d && b(k).css(d);
        ...
        this.each(function () {
            ...
            if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function (a) {
                ...
                if (a)try {
                    ...
                    c = b.jgrid.htmlDecode(b("td:eq(" + d +
                        ")", a).html())
                }
            }
        });
        ...
        var d = [], a, i = 0, h, g, j, e = "boolean" !== typeof e ? !1 : e;
        void 0 === c && (c = !1);
        this.each(function () {
            var k = -1;
                ...
                if (m && 0 < m) {
                    for (; n < m;) {
                        if (b(this.rows[n]).hasClass("jqgrow")) {
                            ...
                            c ?
                                (j = parseFloat(a), i += j, void 0 === g && (g = h = j), h = Math.min(h, j), g = Math.max(g, j)) : e ? d.push({id: this.rows[n].id, value: a}) : d.push(a)
                        }
                        n++
                    }
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                if (this.p.deepempty)b("#" + b.jgrid.jqID(this.p.id) + " tbody:first tr:gt(0)").remove(); else {
                    ...
                    b("#" + b.jgrid.jqID(this.p.id) + " tbody:first").empty().append(e)
                }
        ...
        var e = b.extend({onEnter: null, onSpace: null,
            onLeftKey: null, onRightKey: null, scrollingRows: !0}, f || {});
        return this.each(function () {
            var c = this;
            b("body").is("[role]") || b("body").attr("role", "application");
            c.p.scrollrows = e.scrollingRows;
            b(c).keydown(function (d) {
                var a = b(c).find("tr[tabindex=0]")[0], f, h, g, j = c.p.treeReader.expanded_field;
                if (a)if (g = c.p._index[a.id], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                    if (38 === d.keyCode) {
                        h = a.previousSibling;
                        f = "";
                        if (h)if (b(h).is(":hidden"))for (; h;) {
                            if (h = h.previousSibling, !b(h).is(":hidden") &&
                                b(h).hasClass("jqgrow")) {
                                f = h.id;
                                break
                            }
                    ...
                    37 === d.keyCode && (c.p.treeGrid && c.p.data[g][j] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyLeft", [c.p.selrow]), b.isFunction(e.onLeftKey) && e.onLeftKey.call(c,
                        c.p.selrow));
                    39 === d.keyCode && (c.p.treeGrid && !c.p.data[g][j] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyRight", [c.p.selrow]), b.isFunction(e.onRightKey) && e.onRightKey.call(c, c.p.selrow))
        ...
        getLocalRow: function (b) {
            var e = !1, c;
            this.each(function () {
                void 0 !== b && (c = this.p._index[b], 0 <= c && (e = this.p.data[c]))
            });
            return e
        }})
})(jQuery);
(function (a) {
    ...
    a.fmatter.util = {NumberFormat: function (c, b) {
        ...
        if (a.fmatter.isNumber(c)) {
            var d = 0 > c, e = "" + c, f = b.decimalSeparator || ".", h;
            if (a.fmatter.isNumber(b.decimalPlaces)) {
                var g = b.decimalPlaces, e = Math.pow(10, g), e = "" + Math.round(c *
                    e) / e;
                h = e.lastIndexOf(".");
                if (0 < g) {
        ...
        var f = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, h = "string" === typeof b ? b.match(f) :
            null, f = function (a, b) {
            a = "" + a;
            for (b = parseInt(b, 10) || 2; a.length < b;)a = "0" + a;
            return a
        }, g = {m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0}, i = 0, j, k = ["i18n"];
        k.i18n = {dayNames: e.dayNames, monthNames: e.monthNames};
        e.masks.hasOwnProperty(c) && (c = e.masks[c]);
        if (!isNaN(b - 0) && "u" == ("" + c).toLowerCase())i = new Date(1E3 * parseFloat(b)); else if (b.constructor === Date)i = b; else if (null !== h)i = new Date(parseInt(h[1], 10)), h[3] && (c = 60 * Number(h[5]) + Number(h[6]), c *= "-" == h[4] ? 1 : -1, c -= i.getTimezoneOffset(), i.setTime(Number(Number(i) + 6E4 * c))); else {
            b =
                ("" + b).split(/[\\\/:_;.,\t\T\s-]/);
            c = c.split(/[\\\/:_;.,\t\T\s-]/);
            h = 0;
    ...
    a.fn.fmatter.link = function (c, b) {
        ...
        return!a.fmatter.isEmpty(c) ? "<a " + e + ' href="' + c + '">' +
            c + "</a>" : a.fn.fmatter.defaultFormat(c, b)
    };
    a.fn.fmatter.showlink = function (c, b) {
        ...
        return a.fmatter.isString(c) || a.fmatter.isNumber(c) ? "<a " + e + ' href="' + d + '">' + c + "</a>" : a.fn.fmatter.defaultFormat(c,
            b)
    };
    ...
    a.fn.fmatter.number = function (c, b) {
        ...
        void 0 !== b.colModel && !a.fmatter.isUndefined(b.colModel.formatoptions) && (d = a.extend({}, d, b.colModel.formatoptions));
        return a.fmatter.isEmpty(c) ? d.defaultValue : a.fmatter.util.NumberFormat(c,
            d)
    };
    ...
    a.fn.fmatter.date = function (c, b, d, e) {
        d = a.extend({}, b.date);
        void 0 !== b.colModel && !a.fmatter.isUndefined(b.colModel.formatoptions) && (d = a.extend({}, d, b.colModel.formatoptions));
        return!d.reformatAfterEdit && "edit" == e ? a.fn.fmatter.defaultFormat(c,
            b) : !a.fmatter.isEmpty(c) ? a.fmatter.util.DateFormat(d.srcformat, c, d.newformat, d) : a.fn.fmatter.defaultFormat(c, b)
    };
    a.fn.fmatter.select = function (c, b) {
        ...
        a.fmatter.isUndefined(b.colModel.formatoptions) ? a.fmatter.isUndefined(b.colModel.editoptions) || (d = b.colModel.editoptions.value, f = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, h = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter) : (d = b.colModel.formatoptions.value, f = void 0 ===
            b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, h = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter);
        if (d) {
            var g = !0 === b.colModel.editoptions.multiple ? !0 : !1, i = [];
            g && (i = c.split(","), i = a.map(i, function (b) {
                return a.trim(b)
            }));
            if (a.fmatter.isString(d)) {
                var j = d.split(h), k = 0, l;
                for (l = 0; l < j.length; l++)if (h = j[l].split(f), 2 < h.length && (h[1] = a.map(h,function (a, b) {
                    if (b > 0)return a
                }).join(f)), g)-1 < a.inArray(h[0], i) && (e[k] = h[1], k++); else if (a.trim(h[0]) ==
                    a.trim(c)) {
                    e[0] = h[1];
                    break
                }
    ...
    a.fn.fmatter.rowactions = function (c) {
        var b = a(this).closest("tr.jqgrow"), d = a(this).parent(), e = b.attr("id"), f = a(this).closest("table.ui-jqgrid-btable"), h = f[0], g = h.p, i = g.colModel[a.jgrid.getCellIndex(this)], j = {keys: !1, onEdit: null, onSuccess: null, afterSave: null, onError: null, afterRestore: null, extraparam: {}, url: null, restoreAfterError: !0,
            mtype: "POST", delOptions: {}, editOptions: {}}, k = function (b) {
        ...
        b = {keys: j.keys, oneditfunc: j.onEdit, successfunc: j.onSuccess, url: j.url, extraparam: j.extraparam, aftersavefunc: function (b, c) {
            a.isFunction(j.afterSave) && j.afterSave.call(h, b, c);
            d.find("div.ui-inline-edit,div.ui-inline-del").show();
            d.find("div.ui-inline-save,div.ui-inline-cancel").hide()
        }, errorfunc: j.onError, afterrestorefunc: k, restoreAfterError: j.restoreAfterError, mtype: j.mtype};
        switch (c) {
            case "edit":
    ...
    a.unformat = function (c, b, d, e) {
        var f, h = b.colModel.formatter, g = b.colModel.formatoptions || {}, i = /([\.\*\_\'\(\)\{\}\+\?\\])/g, j = b.colModel.unformat || a.fn.fmatter[h] && a.fn.fmatter[h].unformat;
        if (void 0 !== j && a.isFunction(j))f = j.call(this, a(c).text(), b, c); else if (!a.fmatter.isUndefined(h) && a.fmatter.isString(h))switch (f = a.jgrid.formatter || {}, h) {
            case "integer":
                g = a.extend({}, f.integer, g);
                b = g.thousandsSeparator.replace(i, "\\$1");
                f = a(c).text().replace(RegExp(b,
                    "g"), "");
                break;
            case "number":
            ...
            case "currency":
                ...
                break;
            case "checkbox":
                g = b.colModel.editoptions ?
                    b.colModel.editoptions.value.split(":") : ["Yes", "No"];
    ...
    a.unformat.select = function (c, b, d, e) {
        ...
        c = a(c).text();
        if (!0 === e)return c;
        var e = a.extend({}, !a.fmatter.isUndefined(b.colModel.formatoptions) ? b.colModel.formatoptions : b.colModel.editoptions), b = void 0 === e.separator ? ":" : e.separator, f = void 0 ===
            e.delimiter ? ";" : e.delimiter;
        if (e.value) {
            var h = e.value, e = !0 === e.multiple ? !0 : !1, g = [];
            e && (g = c.split(","), g = a.map(g, function (b) {
                return a.trim(b)
            }));
            if (a.fmatter.isString(h)) {
                var i = h.split(f), j = 0, k;
                for (k = 0; k < i.length; k++)if (f = i[k].split(b), 2 < f.length && (f[1] = a.map(f,function (a, b) {
                    if (b > 0)return a
                }).join(b)), e)-1 < a.inArray(f[1], g) && (d[j] = f[0], j++); else if (a.trim(f[1]) == a.trim(c)) {
                    d[0] = f[0];
                    break
                }
...
(function (a) {
    a.jgrid.extend({getColProp: function (a) {
        ...
        return this.each(function () {
            ...
            if (this.grid) {
                a || (a = this.p.sortname);
                for (f = 0; f < this.p.colModel.length; f++)if (this.p.colModel[f].index ==
                    a || this.p.colModel[f].name == a) {
                    g = f;
                    break
                }
        ...
        setGridState: function (b) {
            ...
            b = a.extend({autosearch: !0, searchOnEnter: !0, beforeSearch: null, afterSearch: null, beforeClear: null, afterClear: null, searchurl: "", stringResult: !1, groupOp: "AND", defaultSearch: "bw"}, b || {});
            return this.each(function () {
                var c = this;
                if (!this.ftoolbar) {
                    var d = function () {
                        ...
                        a.each(c.p.colModel, function () {
                            ...
                            if (f = a("#gs_" + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).val())e[h] = f, l[h] = k, d++; else try {
                        ...
                        if (!0 === b.stringResult || "local" == c.p.datatype) {
                            var i = '{"groupOp":"' + b.groupOp + '","rules":[', n = 0;
                            ...
                            i += "]}";
                            a.extend(c.p.postData, {filters: i});
                        ...
                        var o;
                        c.p.searchurl && (o = c.p.url, a(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                        var q = "stop" === a(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                        !q && a.isFunction(b.beforeSearch) && (q =
                            b.beforeSearch.call(c));
                        q || a(c).jqGrid("setGridParam", {search: g}).trigger("reloadGrid", [
                            {page: 1}
                        ]);
                        o && a(c).jqGrid("setGridParam", {url: o});
                        a(c).triggerHandler("jqGridToolbarAfterSearch");
                        a.isFunction(b.afterSearch) && b.afterSearch.call(c)
                    }, g = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"), f;
                    a.each(c.p.colModel, function () {
                        var e = this, j, m, h, l;
                        ...
                        if (this.search)switch (this.stype) {
                            case "select":
                                if (l = this.surl || h.dataUrl)a.ajax(a.extend({url: l, dataType: "html", success: function (f) {
                                    if (h.buildSelect !== void 0)(f = h.buildSelect(f)) && a(j).append(f); else a(j).append(f);
                                    h.defaultValue !== void 0 && a("select", j).val(h.defaultValue);
                                    a("select", j).attr({name: e.index || e.name, id: "gs_" + e.name});
                                    h.attr &&
                                    ...
                                    var k, p, i;
                                    e.searchoptions ? (k = void 0 === e.searchoptions.value ? "" : e.searchoptions.value, p = void 0 === e.searchoptions.separator ? ":" : e.searchoptions.separator, i = void 0 === e.searchoptions.delimiter ? ";" : e.searchoptions.delimiter) : e.editoptions && (k = void 0 === e.editoptions.value ? "" :
                                        e.editoptions.value, p = void 0 === e.editoptions.separator ? ":" : e.editoptions.separator, i = void 0 === e.editoptions.delimiter ? ";" : e.editoptions.delimiter);
                                    if (k) {
                                        ...
                                        } else if ("object" === typeof k)for (n in k)k.hasOwnProperty(n) && (i = document.createElement("option"),
                                            i.value = n, i.innerHTML = k[n], l.appendChild(i));
                                ...
                                break;
                            case "text":
                                p = void 0 !== h.defaultValue ? h.defaultValue : "", a(j).append("<input type='text' style='width:95%;padding:0px;' name='" + (e.index || e.name) + "' id='gs_" + e.name + "' value='" + p + "'/>"), h.attr && a("input", j).attr(h.attr), a.jgrid.bindEv(a("input", j)[0], h, c), !0 === b.autosearch && (b.searchOnEnter ?
                                    a("input", j).keypress(function (a) {
                    ...
                    this.clearToolbar = function (e) {
                        var d = {}, f = 0, h, e = "boolean" !== typeof e ? !0 : e;
                        a.each(c.p.colModel, function () {
                            var b;
                            ...
                            switch (this.stype) {
                                case "select":
                                    ...
                                    if (void 0 !== b)d[h] = b, f++; else try {
                                        delete c.p.postData[h]
                                    } catch (e) {
                                    }
                                    break;
                                case "text":
                                    if (a("#gs_" + a.jgrid.jqID(this.name), !0 === this.frozen &&
                                        !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv).val(b), void 0 !== b)d[h] = b, f++; else try {
                                        delete c.p.postData[h]
                                    } catch (k) {
                                    }
                            }
                        ...
                        var g = 0 < f ? !0 : !1;
                        if (!0 === b.stringResult || "local" == c.p.datatype) {
                            var k = '{"groupOp":"' + b.groupOp + '","rules":[', p = 0;
                        ...
                        var i;
                        c.p.searchurl && (i = c.p.url, a(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                        var n = "stop" === a(c).triggerHandler("jqGridToolbarBeforeClear") ? !0 : !1;
                        !n && a.isFunction(b.beforeClear) && (n = b.beforeClear.call(c));
                        n || e && a(c).jqGrid("setGridParam", {search: g}).trigger("reloadGrid", [
                            {page: 1}
                        ]);
                        i && a(c).jqGrid("setGridParam", {url: i});
            ...
            return this.each(function () {
                var c, d, g, f, e, j;
                d = this.grid;
                var m = a("table.ui-jqgrid-htable thead", d.hDiv), h = this.p.colModel;
                if (d) {
            ...
            return this.each(function () {
                ...
                var c, d, g = 0, f, e, j, m, h, l = this.p.colModel, k = l.length, p = this.grid.headers, i = a("table.ui-jqgrid-htable", this.grid.hDiv), n = i.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
                f = i.children("thead");
                var o = i.find(".jqg-first-row-header");
                void 0 === o[0] ? o = a("<tr>",
                    {role: "row", "aria-hidden": "true"}).addClass("jqg-first-row-header").css("height", "auto") : o.empty();
                ...
                a(this).prepend(f);
                f = a("<tr>", {role: "rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");
                for (c = 0; c < k; c++)if (j = p[c].el, m = a(j), d = l[c], e = {height: "0px", width: p[c].width + "px", display: d.hidden ? "none" : ""}, a("<th>", {role: "gridcell"}).css(e).addClass("ui-first-th-" + this.p.direction).appendTo(o), j.style.width =
                    "", e = r(d.name, b.groupHeaders), 0 <= e) {
                    e = b.groupHeaders[e];
                    g = e.numberOfColumns;
                    h = e.titleText;
                    for (e = d = 0; e < g && c + e < k; e++)l[c + e].hidden || d++;
                    e = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({height: "22px", "border-top": "0px none"}).html(h);
                    ...
                    f.append(j);
                    g -= 1
                } else 0 === g ? b.useColSpanStyle ? m.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" +
                    this.p.direction).css({display: d.hidden ? "none" : "", "border-top": "0px none"}).insertBefore(m), f.append(j)) : (f.append(j), g--);
...
(function (a) {
    a.extend(a.jgrid, {showModal: function (a) {
        ...
        var g = {width: 290, height: "auto", dataheight: "auto", drag: !0, resize: !1, left: 250, top: 170, zIndex: 1E3, jqModal: !0, modal: !1, closeOnEscape: !0, align: "center", buttonalign: "center", buttons: []};
        a.extend(!0, g, a.jgrid.jqModal || {}, {caption: "<b>" + d + "</b>"}, e || {});
        var h = g.jqModal, f = this;
        a.fn.jqm && !h && (h = !1);
        d = "";
        if (0 < g.buttons.length)for (e = 0; e < g.buttons.length; e++)void 0 === g.buttons[e].id && (g.buttons[e].id = "info_button_" + e), d +=
        ...
        switch (d) {
            case "textarea":
                ...
                e ? b.cols || a(f).css({width: "98%"}) : b.cols || (b.cols = 20);
                b.rows || (b.rows = 2);
            ...
            case "checkbox":
                ...
                f.type = "checkbox";
                b.value ? (d = b.value.split(":"),
                    c === d[0] && (f.checked = !0, f.defaultChecked = !0), f.value = d[0], a(f).attr("offval", d[1])) : (d = c.toLowerCase(), 0 > d.search(/(false|0|no|off|undefined)/i) && "" !== d ? (f.checked = !0, f.defaultChecked = !0, f.value = c) : f.value = "on", a(f).attr("offval", "off"));
                h(f, b, ["value"]);
            ...
            case "select":
                ...
                if (void 0 !== b.dataUrl)d = b.name ? ("" +
                    b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id, e = b.postData || g.postData, i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : e = void 0, a.ajax(a.extend({url: b.dataUrl, type: "GET", dataType: "html", data: a.isFunction(e) ? e.call(i, d, c, "" + b.name) : e, context: {elem: f, options: b, vl: c}, success: function (b) {
                    var d = [], c = this.elem, e = this.vl, f = a.extend({}, this.options), g = f.multiple === true;
                    a.isFunction(f.buildSelect) && (b = f.buildSelect.call(i, b));
                    if (b = a(b).html()) {
                        a(c).append(b);
                        h(c, f);
                        if (f.size === void 0)f.size =
                            g ? 3 : 1;
                        if (g) {
                            d = e.split(",");
                    ...
                    var n,
                        k, l = void 0 === b.separator ? ":" : b.separator, g = void 0 === b.delimiter ? ";" : b.delimiter;
                    if ("string" === typeof b.value) {
                        ...
                        for (j = 0; j < n.length; j++) {
                            ...
                            if (d && (-1 < a.inArray(a.trim(k[1]), e) || -1 < a.inArray(a.trim(k[0]), e)))g.selected =
                                "selected"
                        }
            ...
            case "button":
                ...
                f.value = c;
                h(f, b);
                "button" != d && (e ? b.size || a(f).css({width: "98%"}) : b.size || (b.size = 20));
                a(f).attr("role", j);
                break;
            case "image":
            case "file":
            ...
            case "custom":
                ...
                try {
                    ...
                    "e1" == m && a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " +
                        a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose), "e2" == m ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : a.jgrid.info_dialog(a.jgrid.errors.errcap, "string" === typeof m ? m : m.message, a.jgrid.edit.bClose)
                }
        }
        return f
    }, checkDate: function (a, b) {
        var c = {}, e, a = a.toLowerCase();
        ...
        e = -1;
        var g, h = -1, f = -1, i;
        for (i = 0; i < a.length; i++)g =
            isNaN(b[i]) ? 0 : parseInt(b[i], 10), c[a[i]] = g, g = a[i], -1 != g.indexOf("y") && (e = i), -1 != g.indexOf("m") && (f = i), -1 != g.indexOf("d") && (h = i);
        ...
        if (void 0 === e)if ("string" === typeof b) {
            e = 0;
            for (g = c.p.colModel.length; e <
                g; e++)if (c.p.colModel[e].name == b) {
        ...
        } else 0 <= b && (h = c.p.colModel[b].editrules); else h = e, f = void 0 === g ? "_" : g;
        if (h) {
            f || (f = c.p.colNames[b]);
            ...
            if (void 0 !== h.minValue && !isNaN(h.minValue) && parseFloat(d) < parseFloat(h.minValue))return[!1,
                f + ": " + a.jgrid.edit.msg.minValue + " " + h.minValue, ""];
            if (void 0 !== h.maxValue && !isNaN(h.maxValue) && parseFloat(d) > parseFloat(h.maxValue))return[!1, f + ": " + a.jgrid.edit.msg.maxValue + " " + h.maxValue, ""];
            if (!0 === h.email && !(!1 === e && a.jgrid.isEmpty(d)) && (g = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,
                !g.test(d)))return[!1, f + ": " + a.jgrid.edit.msg.email, ""];
...
(function (a) {
    ...
    a.jgrid.extend({searchGrid: function (b) {
        b = a.extend(!0, {recreateFilter: !1, drag: !0, sField: "searchField", sValue: "searchString", sOper: "searchOper", sFilter: "filters", loadDefaults: !0, beforeShowSearch: null, afterShowSearch: null, onInitializeSearch: null, afterRedraw: null, afterChange: null, closeAfterSearch: !1, closeAfterReset: !1, closeOnEscape: !1, searchOnEnter: !1, multipleSearch: !1, multipleGroup: !1, top: 0, left: 0, jqModal: !0, modal: !1, resize: !0, width: 450, height: "auto", dataheight: "auto", showQuery: !1,
            errorcheck: !0, sopt: null, stringResult: void 0, onClose: null, onSearch: null, onReset: null, toTop: !0, overlay: 30, columns: [], tmplNames: null, tmplFilters: null, tmplLabel: " Template: ", showOnLoad: !1, layer: null}, a.jgrid.search, b || {});
        return this.each(function () {
            function d(c) {
                r = a(e).triggerHandler("jqGridFilterBeforeShow", [c]);
                void 0 === r && (r = !0);
                r && a.isFunction(b.beforeShowSearch) && (r = b.beforeShowSearch.call(e, c));
                r && (a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {gbox: "#gbox_" + a.jgrid.jqID(i), jqm: b.jqModal, modal: b.modal,
                    overlay: b.overlay, toTop: b.toTop}), a(e).triggerHandler("jqGridFilterAfterShow", [c]), a.isFunction(b.afterShowSearch) && b.afterShowSearch.call(e, c))
            }

            var e = this;
            if (e.grid) {
                var i = "fbox_" + e.p.id, r = !0, q = {themodal: "searchmod" + i, modalhead: "searchhd" + i, modalcontent: "searchcnt" + i, scrollelm: i}, s = e.p.postData[b.sFilter];
                "string" === typeof s && (s = a.jgrid.parse(s));
                !0 === b.recreateFilter && a("#" + a.jgrid.jqID(q.themodal)).remove();
                if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0])d(a("#fbox_" + a.jgrid.jqID(+e.p.id))); else {
                    var m =
                        a("<div><div id='" + i + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(e.p.id)), f = "left", h = "";
                    "rtl" == e.p.direction && (f = "right", h = " style='text-align:left'", m.attr("dir", "rtl"));
                    var o = a.extend([], e.p.colModel), w = "<a href='javascript:void(0)' id='" + i + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>", c = "<a href='javascript:void(0)' id='" + i + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" +
                        b.Reset + "</a>", p = "", g = "", n, k = !1, l = -1;
                    b.showQuery && (p = "<a href='javascript:void(0)' id='" + i + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");
                    b.columns.length ? o = b.columns : a.each(o, function (a, b) {
                    ...
                    if (!s && n || !1 === b.multipleSearch) {
                        var x =
                            "eq";
                        0 <= l && o[l].searchoptions && o[l].searchoptions.sopt ? x = o[l].searchoptions.sopt[0] : b.sopt && b.sopt.length && (x = b.sopt[0]);
                        s = {groupOp: "AND", rules: [
                            {field: n, op: x, data: ""}
                        ]}
                    }
                    k = !1;
                    b.tmplNames && b.tmplNames.length && (k = !0, g = b.tmplLabel, g += "<select class='ui-template'>", g += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                        g = g + ("<option value='" + a + "'>" + b + "</option>")
                    }), g += "</select>");
                    f = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + i + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" +
                        f + "'>" + c + g + "</td><td class='EditButton' " + h + ">" + p + w + "</td></tr></tbody></table>";
                    i = a.jgrid.jqID(i);
                    a("#" + i).jqFilter({columns: o, filter: b.loadDefaults ? s : null, showQuery: b.showQuery, errorcheck: b.errorcheck, sopt: b.sopt, groupButton: b.multipleGroup, ruleButtons: b.multipleSearch, afterRedraw: b.afterRedraw, _gridsopt: a.jgrid.search.odata, ajaxSelectOptions: e.p.ajaxSelectOptions, groupOps: b.groupOps, onChange: function () {
                        this.p.showQuery && a(".query", this).html(this.toUserFriendlyString());
                        a.isFunction(b.afterChange) &&
                        b.afterChange.call(e, a("#" + i), b)
                    ...
                    b.gbox = "#gbox_" + i;
                    b.layer ? a.jgrid.createModal(q,
                        m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {position: "relative"}) : a.jgrid.createModal(q, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]);
                    ...
                    a("#" + i + "_search").bind("click", function () {
                        ...
                        if (b.stringResult) {
                            ...
                            d[b.sField] = h.rules[0].field;
                            d[b.sValue] = h.rules[0].data;
                            d[b.sOper] = h.rules[0].op;
                            d[b.sFilter] = ""
                        }
                        e.p.search = true;
                        ...
                        b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {gb: "#gbox_" + a.jgrid.jqID(e.p.id), jqm: b.jqModal, onClose: b.onClose});
                        return false
                    });
    ...
    }, editGridRow: function (v, d) {
        d = a.extend(!0, {top: 0, left: 0, width: 300, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: null, mtype: "POST", clearAfterAdd: !0, closeAfterEdit: !1, reloadAfterSubmit: !0, onInitializeForm: null, beforeInitData: null,
            beforeShowForm: null, afterShowForm: null, beforeSubmit: null, afterSubmit: null, onclickSubmit: null, afterComplete: null, onclickPgButtons: null, afterclickPgButtons: null, editData: {}, recreateForm: !1, jqModal: !0, closeOnEscape: !1, addedrow: "first", topinfo: "", bottominfo: "", saveicon: [], closeicon: [], savekey: [!1, 13], navkeys: [!1, 38, 40], checkOnSubmit: !1, checkOnUpdate: !1, _savedData: {}, processing: !1, onClose: null, ajaxEditOptions: {}, serializeEditData: null, viewPagerButtons: !0}, a.jgrid.edit, d || {});
        b[a(this)[0].p.id] = d;
        return this.each(function () {
            function e() {
                a(k +
                    " > tbody > tr > td > .FormElement").each(function () {
                        var b = a(".customelement", this);
                        if (b.length) {
                            var d = a(b[0]).attr("name");
                            a.each(c.p.colModel, function () {
                                if (this.name === d && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (j[d] = this.editoptions.custom_value.call(c, a("#" + a.jgrid.jqID(d), k), "get"), void 0 === j[d])throw"e1";
                                    } catch (b) {
                                        "e1" === b ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : a.jgrid.info_dialog(a.jgrid.errors.errcap,
                                            b.message, a.jgrid.edit.bClose)
                                    }
                                    return!0
                                }
                            })
                            ...
                            c.p.autoencode && (j[this.name] = a.jgrid.htmlEncode(j[this.name]))
                        }
                    });
                return!0
            }
            ...
            function i(d, e, j, h) {
                var l, f, k, t = 0, i, u, m, n = [], o = !1, v = "", p;
                for (p = 1; p <= h; p++)v += "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
                "_empty" != d && (o = a(e).jqGrid("getInd", d));
                a(e.p.colModel).each(function (p) {
                    l = this.name;
                    u = (f = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "";
                    if ("cb" !== l && "subgrid" !== l && !0 === this.editable && "rn" !== l) {
                        if (!1 === o)i = ""; else if (l == e.p.ExpandColumn && !0 === e.p.treeGrid)i = a("td[role='gridcell']:eq(" + p + ")", e.rows[o]).text(); else {
                            try {
                                i = a.unformat.call(e, a("td[role='gridcell']:eq(" + p + ")", e.rows[o]), {rowId: d, colModel: this}, p)
                            } catch (r) {
                                i = this.edittype && "textarea" == this.edittype ? a("td[role='gridcell']:eq(" + p + ")", e.rows[o]).text() : a("td[role='gridcell']:eq(" + p + ")", e.rows[o]).html()
                            }
                            if (!i || "&nbsp;" == i || "&#160;" == i || 1 == i.length && 160 == i.charCodeAt(0))i = ""
                        }
                        var s =
                            a.extend({}, this.editoptions || {}, {id: l, name: l}), q = a.extend({}, {elmprefix: "", elmsuffix: "", rowabove: !1, rowcontent: ""}, this.formoptions || {}), x = parseInt(q.rowpos, 10) || t + 1, z = parseInt(2 * (parseInt(q.colpos, 10) || 1), 10);
                        "_empty" == d && s.defaultValue && (i = a.isFunction(s.defaultValue) ? s.defaultValue.call(c) : s.defaultValue);
                        this.edittype || (this.edittype = "text");
                        c.p.autoencode && (i = a.jgrid.htmlDecode(i));
                        m = a.jgrid.createEl.call(c, this.edittype, s, i, !1, a.extend({}, a.jgrid.ajaxOptions, e.p.ajaxSelectOptions || {}));
                        "" ===
                            i && "checkbox" == this.edittype && (i = a(m).attr("offval"));
                        "" === i && "select" == this.edittype && (i = a("option:eq(0)", m).text());
                        if (b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate)b[c.p.id]._savedData[l] = i;
                        a(m).addClass("FormElement");
                        ("text" == this.edittype || "textarea" == this.edittype) && a(m).addClass("ui-widget-content ui-corner-all");
                        k = a(j).find("tr[rowpos=" + x + "]");
                        if (q.rowabove) {
                            var w = a("<tr><td class='contentinfo' colspan='" + 2 * h + "'>" + q.rowcontent + "</td></tr>");
                            a(j).append(w);
                            w[0].rp = x
                        }
                        0 === k.length && (k = a("<tr " +
                            u + " rowpos='" + x + "'></tr>").addClass("FormData").attr("id", "tr_" + l), a(k).append(v), a(j).append(k), k[0].rp = x);
                        a("td:eq(" + (z - 2) + ")", k[0]).html(void 0 === q.label ? e.p.colNames[p] : q.label);
                        a("td:eq(" + (z - 1) + ")", k[0]).append(q.elmprefix).append(m).append(q.elmsuffix);
                        a.isFunction(s.custom_value) && "_empty" !== d && s.custom_value.call(c, a("#" + l, "#" + g), "set", i);
                        a.jgrid.bindEv(m, s, c);
                        n[t] = p;
                        t++
                    }
                });
                if (0 < t && (p = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * h - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" +
                    e.p.id + "_id' value='" + d + "'/></td></tr>"), p[0].rp = t + 999, a(j).append(p), b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate))b[c.p.id]._savedData[e.p.id + "_id"] = d;
                return n
            }

            function r(d, e, g) {
                var j, h = 0, l, f, i, t, m;
                if (b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate)b[c.p.id]._savedData = {}, b[c.p.id]._savedData[e.p.id + "_id"] = d;
                var u = e.p.colModel;
                if ("_empty" == d)a(u).each(function () {
                    j = this.name;
                    i = a.extend({}, this.editoptions || {});
                    if ((f = a("#" + a.jgrid.jqID(j), "#" + g)) && f.length && null !== f[0])if (t = "", i.defaultValue ?
                    ...
                    var p = a(e).jqGrid("getInd", d, !0);
                    p && (a('td[role="gridcell"]', p).each(function (f) {
                        j = u[f].name;
                        if ("cb" !== j && "subgrid" !== j && "rn" !== j && !0 === u[f].editable) {
                            if (j == e.p.ExpandColumn && !0 === e.p.treeGrid)l = a(this).text(); else try {
                                l = a.unformat.call(e, a(this), {rowId: d, colModel: u[f]}, f)
                            } catch (i) {
                                l = "textarea" == u[f].edittype ? a(this).text() : a(this).html()
                            }
                            c.p.autoencode && (l = a.jgrid.htmlDecode(l));
                            if (!0 === b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate)b[c.p.id]._savedData[j] = l;
                            j =
                                a.jgrid.jqID(j);
                            switch (u[f].edittype) {
                                case "password":
                                ...
                                case "image":
                                case "textarea":
                                    if ("&nbsp;" == l || "&#160;" == l || 1 == l.length && 160 == l.charCodeAt(0))l = "";
                                    a("#" + j, "#" + g).val(l);
                                    break;
                                case "select":
                                    var t = l.split(","), t = a.map(t, function (c) {
                                        return a.trim(c)
                                    });
                                    a("#" + j + " option", "#" + g).each(function () {
                                        this.selected = !u[f].editoptions.multiple && (a.trim(l) == a.trim(a(this).text()) || t[0] == a.trim(a(this).text()) || t[0] == a.trim(a(this).val())) ? !0 : u[f].editoptions.multiple ? -1 < a.inArray(a.trim(a(this).text()),
                                            t) || -1 < a.inArray(a.trim(a(this).val()), t) ? !0 : !1 : !1
                                    });
                                    break;
                                case "checkbox":
                                    l = "" + l;
                                    u[f].editoptions && u[f].editoptions.value ? u[f].editoptions.value.split(":")[0] == l ? (a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("defaultChecked", !1)) : (l = l.toLowerCase(), 0 > l.search(/(false|0|no|off|undefined)/i) && "" !== l ? (a("#" + j, "#" + g)[c.p.useProp ?
                                        "prop" : "attr"]("checked", !0), a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + j, "#" + g)[c.p.useProp ? "prop" : "attr"]("defaultChecked", !1)));
                                    break;
                                case "custom":
                                    try {
                                        if (u[f].editoptions && a.isFunction(u[f].editoptions.custom_value))u[f].editoptions.custom_value.call(c, a("#" + j, "#" + g), "set", l); else throw"e1";
                                    } catch (k) {
                                        "e1" == k ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose) :
                                            a.jgrid.info_dialog(a.jgrid.errors.errcap, k.message, a.jgrid.edit.bClose)
                                    }
                            }
                            h++
                        }
            ...
            function s() {
                var e, f = [!0, "", ""], h = {}, t = c.p.prmNames, i, u, m, o, n, v = a(c).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + g), A]);
                v && "object" === typeof v && (j = v);
                a.isFunction(b[c.p.id].beforeCheckValues) && (v = b[c.p.id].beforeCheckValues.call(c,
                    j, a("#" + g), "_empty" == j[c.p.id + "_id"] ? t.addoper : t.editoper)) && "object" === typeof v && (j = v);
                for (m in j)if (j.hasOwnProperty(m) && (f = a.jgrid.checkValues.call(c, j[m], m, c), !1 === f[0]))break;
                q();
                f[0] && (h = a(c).triggerHandler("jqGridAddEditClickSubmit", [b[c.p.id], j, A]), void 0 === h && a.isFunction(b[c.p.id].onclickSubmit) && (h = b[c.p.id].onclickSubmit.call(c, b[c.p.id], j) || {}), f = a(c).triggerHandler("jqGridAddEditBeforeSubmit", [j, a("#" + g), A]), void 0 === f && (f = [!0, "", ""]), f[0] && a.isFunction(b[c.p.id].beforeSubmit) && (f = b[c.p.id].beforeSubmit.call(c,
                    j, a("#" + g))));
                if (f[0] && !b[c.p.id].processing) {
                    b[c.p.id].processing = !0;
                    a("#sData", k + "_2").addClass("ui-state-active");
                    u = t.oper;
                    i = t.id;
                    j[u] = "_empty" == a.trim(j[c.p.id + "_id"]) ? t.addoper : t.editoper;
                    j[u] != t.addoper ? j[i] = j[c.p.id + "_id"] : void 0 === j[i] && (j[i] = j[c.p.id + "_id"]);
                    delete j[c.p.id + "_id"];
                    j = a.extend(j, b[c.p.id].editData, h);
                    if (!0 === c.p.treeGrid)for (n in j[u] == t.addoper && (o = a(c).jqGrid("getGridParam", "selrow"), j["adjacency" == c.p.treeGridModel ? c.p.treeReader.parent_id_field : "parent_id"] = o), c.p.treeReader)c.p.treeReader.hasOwnProperty(n) &&
                    (h = c.p.treeReader[n], j.hasOwnProperty(h) && !(j[u] == t.addoper && "parent_id_field" === n) && delete j[h]);
                    j[i] = a.jgrid.stripPref(c.p.idPrefix, j[i]);
                    n = a.extend({url: b[c.p.id].url || a(c).jqGrid("getGridParam", "editurl"), type: b[c.p.id].mtype, data: a.isFunction(b[c.p.id].serializeEditData) ? b[c.p.id].serializeEditData.call(c, j) : j, complete: function (h, m) {
                        var n;
                        j[i] = c.p.idPrefix + j[i];
                        if (m != "success") {
                            f[0] = false;
                            f[1] = a(c).triggerHandler("jqGridAddEditErrorTextFormat", [h, A]);
                            f[1] = a.isFunction(b[c.p.id].errorTextFormat) ?
                                b[c.p.id].errorTextFormat.call(c, h) : m + " Status: '" + h.statusText + "'. Error code: " + h.status
                        } else {
                            f = a(c).triggerHandler("jqGridAddEditAfterSubmit", [h, j, A]);
                            f === void 0 && (f = [true, "", ""]);
                            f[0] && a.isFunction(b[c.p.id].afterSubmit) && (f = b[c.p.id].afterSubmit.call(c, h, j))
                        }
                        if (f[0] === false) {
                            a("#FormError>td", k).html(f[1]);
                            a("#FormError", k).show()
                        } else {
                            a.each(c.p.colModel, function () {
                            ...
                            if (j[u] == t.addoper) {
                                ...
                                j[i] = f[2];
                                if (b[c.p.id].closeAfterAdd) {
                                    if (b[c.p.id].reloadAfterSubmit)a(c).trigger("reloadGrid"); else if (c.p.treeGrid === true)a(c).jqGrid("addChildNode", f[2], o, j); else {
                                        a(c).jqGrid("addRowData", f[2], j, d.addedrow);
                                        a(c).jqGrid("setSelection", f[2])
                                    }
                                    a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose})
                                } else if (b[c.p.id].clearAfterAdd) {
                                    b[c.p.id].reloadAfterSubmit ?
                                        a(c).trigger("reloadGrid") : c.p.treeGrid === true ? a(c).jqGrid("addChildNode", f[2], o, j) : a(c).jqGrid("addRowData", f[2], j, d.addedrow);
                                    r("_empty", c, g)
                                } else b[c.p.id].reloadAfterSubmit ? a(c).trigger("reloadGrid") : c.p.treeGrid === true ? a(c).jqGrid("addChildNode", f[2], o, j) : a(c).jqGrid("addRowData", f[2], j, d.addedrow)
                            } else {
                                if (b[c.p.id].reloadAfterSubmit) {
                                    a(c).trigger("reloadGrid");
                                    b[c.p.id].closeAfterEdit || setTimeout(function () {
                                        a(c).jqGrid("setSelection", j[i])
                                    }, 1E3)
                                } else c.p.treeGrid === true ? a(c).jqGrid("setTreeRow",
                                    j[i], j) : a(c).jqGrid("setRowData", j[i], j);
                                b[c.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose})
                            }
                            if (a.isFunction(b[c.p.id].afterComplete)) {
                                e = h;
                                setTimeout(function () {
                                    a(c).triggerHandler("jqGridAddEditAfterComplete", [e, j, a("#" + g), A]);
                                    b[c.p.id].afterComplete.call(c, e, j, a("#" + g));
                                    e = null
                                }, 500)
                            }
                            if (b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate) {
                                a("#" + g).data("disabled", false);
                                if (b[c.p.id]._savedData[c.p.id + "_id"] !=
                                    "_empty")for (n in b[c.p.id]._savedData)b[c.p.id]._savedData.hasOwnProperty(n) && j[n] && (b[c.p.id]._savedData[n] = j[n])
                            }
                        }
                        b[c.p.id].processing = false;
                        a("#sData", k + "_2").removeClass("ui-state-active");
                        try {
                            a(":input:visible", "#" + g)[0].focus()
                        } catch (v) {
                        }
                    }}, a.jgrid.ajaxOptions, b[c.p.id].ajaxEditOptions);
                    !n.url && !b[c.p.id].useDataProxy && (a.isFunction(c.p.dataProxy) ? b[c.p.id].useDataProxy = !0 : (f[0] = !1, f[1] += " " + a.jgrid.errors.nourl));
                    f[0] && (b[c.p.id].useDataProxy ? (h = c.p.dataProxy.call(c, n, "set_" + c.p.id), void 0 ===
                        h && (h = [!0, ""]), !1 === h[0] ? (f[0] = !1, f[1] = h[1] || "Error deleting the selected row!") : (n.data.oper == t.addoper && b[c.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose}), n.data.oper == t.editoper && b[c.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose}))) : a.ajax(n))
                }
                !1 === f[0] && (a("#FormError>td", k).html(f[1]), a("#FormError", k).show())
            }
            ...
            function f() {
                var d = !0;
                a("#FormError", k).hide();
                if (b[c.p.id].checkOnUpdate && (j = {}, B = {}, e(), F = a.extend({}, j, B), M = m(F, b[c.p.id]._savedData)))a("#" + g).data("disabled", !0), a(".confirm", "#" + l.themodal).show(), d = !1;
                return d
            }

            function h() {
                var d;
                if ("_empty" !== v && void 0 !== c.p.savedRow && 0 < c.p.savedRow.length && a.isFunction(a.fn.jqGrid.restoreRow))for (d = 0; d < c.p.savedRow.length; d++)if (c.p.savedRow[d].id == v) {
            ...
            function o(c, d) {
                var b = d[1].length - 1;
                0 === c ? a("#pData", k + "_2").addClass("ui-state-disabled") : void 0 !== d[1][c - 1] && a("#" + a.jgrid.jqID(d[1][c - 1])).hasClass("ui-state-disabled") ? a("#pData", k + "_2").addClass("ui-state-disabled") : a("#pData", k + "_2").removeClass("ui-state-disabled");
                c == b ? a("#nData", k + "_2").addClass("ui-state-disabled") : void 0 !== d[1][c + 1] && a("#" + a.jgrid.jqID(d[1][c + 1])).hasClass("ui-state-disabled") ? a("#nData", k + "_2").addClass("ui-state-disabled") : a("#nData", k + "_2").removeClass("ui-state-disabled")
            }

            function w() {
                var d = a(c).jqGrid("getDataIDs"), b = a("#id_g", k).val();
                return[a.inArray(b, d), d]
            }

            var c = this;
            if (c.grid && v) {
                var p = c.p.id, g = "FrmGrid_" + p, n = "TblGrid_" + p, k = "#" + a.jgrid.jqID(n), l = {themodal: "editmod" + p, modalhead: "edithd" + p, modalcontent: "editcnt" + p, scrollelm: g}, x = a.isFunction(b[c.p.id].beforeShowForm) ? b[c.p.id].beforeShowForm : !1, z = a.isFunction(b[c.p.id].afterShowForm) ? b[c.p.id].afterShowForm : !1, y = a.isFunction(b[c.p.id].beforeInitData) ? b[c.p.id].beforeInitData : !1, t = a.isFunction(b[c.p.id].onInitializeForm) ?
                    b[c.p.id].onInitializeForm : !1, u = !0, E = 1, H = 0, j, B, F, M, A, g = a.jgrid.jqID(g);
                "new" === v ? (v = "_empty", A = "add", d.caption = b[c.p.id].addCaption) : (d.caption = b[c.p.id].editCaption, A = "edit");
                !0 === d.recreateForm && void 0 !== a("#" + a.jgrid.jqID(l.themodal))[0] && a("#" + a.jgrid.jqID(l.themodal)).remove();
                var I = !0;
                d.checkOnUpdate && d.jqModal && !d.modal && (I = !1);
                if (void 0 !== a("#" + a.jgrid.jqID(l.themodal))[0]) {
                    u = a(c).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + a.jgrid.jqID(g)), A]);
                    void 0 === u && (u = !0);
                    u && y && (u = y.call(c,
                        a("#" + g)));
                    if (!1 === u)return;
                    h();
                    a(".ui-jqdialog-title", "#" + a.jgrid.jqID(l.modalhead)).html(d.caption);
                    a("#FormError", k).hide();
                    b[c.p.id].topinfo ? (a(".topinfo", k).html(b[c.p.id].topinfo), a(".tinfo", k).show()) : a(".tinfo", k).hide();
                    b[c.p.id].bottominfo ? (a(".bottominfo", k + "_2").html(b[c.p.id].bottominfo), a(".binfo", k + "_2").show()) : a(".binfo", k + "_2").hide();
                    r(v, c, g);
                    "_empty" == v || !b[c.p.id].viewPagerButtons ? a("#pData, #nData", k + "_2").hide() : a("#pData, #nData", k + "_2").show();
                    !0 === b[c.p.id].processing && (b[c.p.id].processing = !1, a("#sData", k + "_2").removeClass("ui-state-active"));
                    !0 === a("#" + g).data("disabled") && (a(".confirm", "#" + a.jgrid.jqID(l.themodal)).hide(), a("#" + g).data("disabled", !1));
                    a(c).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + g), A]);
                    x && x.call(c, a("#" + g));
                    a("#" + a.jgrid.jqID(l.themodal)).data("onClose", b[c.p.id].onClose);
                    a.jgrid.viewModal("#" + a.jgrid.jqID(l.themodal), {gbox: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, jqM: !1, overlay: d.overlay, modal: d.modal});
                    I || a(".jqmOverlay").click(function () {
                        if (!f())return false;
                        a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose});
                        return false
                    });
                    a(c).triggerHandler("jqGridAddEditAfterShowForm", [a("#" + g), A]);
                    z && z.call(c, a("#" + g))
                } else {
                    var G = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px", G = a("<form name='FormPost' id='" + g + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + G + ";'></form>").data("disabled", !1), C = a("<table id='" + n + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        u = a(c).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + g), A]);
                    void 0 === u && (u = !0);
                    u && y && (u = y.call(c, a("#" + g)));
                    if (!1 === u)return;
                    h();
                    a(c.p.colModel).each(function () {
                        ...
                        E = Math.max(E, a ? a.colpos || 0 : 0);
                        H = Math.max(H, a ? a.rowpos || 0 : 0)
                    });
                    a(G).append(C);
                    y = a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + 2 * E + "'></td></tr>");
                    y[0].rp = 0;
                    a(C).append(y);
                    y = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='" + 2 * E + "'>" + b[c.p.id].topinfo + "</td></tr>");
                    y[0].rp = 0;
                    a(C).append(y);
                    var u = (y = "rtl" == c.p.direction ? !0 : !1) ? "nData" : "pData", D = y ? "pData" : "nData";
                    i(v, c, C, E);
                    ...
                    d.gbox = "#gbox_" + a.jgrid.jqID(p);
                    var N = !1;
                    !0 === d.closeOnEscape && (d.closeOnEscape = !1, N = !0);
                    n = a("<span></span>").append(G).append(n);
                    a.jgrid.createModal(l, n, d, "#gview_" + a.jgrid.jqID(c.p.id), a("#gbox_" + a.jgrid.jqID(c.p.id))[0]);
                    y && (a("#pData, #nData", k + "_2").css("float", "right"), a(".EditButton", k + "_2").css("text-align",
                        "left"));
                    b[c.p.id].topinfo && a(".tinfo", k).show();
                    b[c.p.id].bottominfo && a(".binfo", k + "_2").show();
                    n = n = null;
                    a("#" + a.jgrid.jqID(l.themodal)).keydown(function (e) {
                        var j = e.target;
                        if (a("#" + g).data("disabled") === true)return false;
                        if (b[c.p.id].savekey[0] === true && e.which == b[c.p.id].savekey[1] && j.tagName != "TEXTAREA") {
                            a("#sData", k + "_2").trigger("click");
                            return false
                        }
                        if (e.which === 27) {
                            if (!f())return false;
                            N && a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: d.gbox, jqm: d.jqModal, onClose: b[c.p.id].onClose});
                            return false
                        }
                        if (b[c.p.id].navkeys[0] ===
                            true) {
                            if (a("#id_g", k).val() == "_empty")return true;
                            if (e.which == b[c.p.id].navkeys[1]) {
                                a("#pData", k + "_2").trigger("click");
                                return false
                            }
                            if (e.which == b[c.p.id].navkeys[2]) {
                                a("#nData", k + "_2").trigger("click");
                                return false
                            }
                        }
                    });
                    d.checkOnUpdate && (a("a.ui-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(l.themodal)).removeClass("jqmClose"), a("a.ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(l.themodal)).unbind("click").click(function () {
                        if (!f())return false;
                        a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" +
                            a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose});
                        return false
                    }));
                    d.saveicon = a.extend([!0, "left", "ui-icon-disk"], d.saveicon);
                    d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon);
                    !0 === d.saveicon[0] && a("#sData", k + "_2").addClass("right" == d.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.saveicon[2] + "'></span>");
                    !0 === d.closeicon[0] && a("#cData", k + "_2").addClass("right" == d.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " +
                        d.closeicon[2] + "'></span>");
                    if (b[c.p.id].checkOnSubmit || b[c.p.id].checkOnUpdate)J = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bYes + "</a>", D = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bNo + "</a>", K = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bExit + "</a>", n = d.zIndex || 999, n++, a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" +
                        n + ";display:none;'>&#160;" + (a.browser.msie && 6 == a.browser.version ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>' : "") + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (n + 1) + "'>" + d.saveData + "<br/><br/>" + J + D + K + "</div>").insertAfter("#" + g), a("#sNew", "#" + a.jgrid.jqID(l.themodal)).click(function () {
                        s();
                        a("#" + g).data("disabled", false);
                        a(".confirm", "#" + a.jgrid.jqID(l.themodal)).hide();
                        return false
                    }), a("#nNew",
                        "#" + a.jgrid.jqID(l.themodal)).click(function () {
                            a(".confirm", "#" + a.jgrid.jqID(l.themodal)).hide();
                            a("#" + g).data("disabled", false);
                            setTimeout(function () {
                                a(":input", "#" + g)[0].focus()
                            ...
                            return false
                        }), a("#cNew", "#" + a.jgrid.jqID(l.themodal)).click(function () {
                        a(".confirm", "#" + a.jgrid.jqID(l.themodal)).hide();
                        a("#" + g).data("disabled", false);
                        a.jgrid.hideModal("#" + a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose});
                        return false
                    });
                    a(c).triggerHandler("jqGridAddEditInitializeForm",
                        [a("#" + g), A]);
                    t && t.call(c, a("#" + g));
                    "_empty" == v || !b[c.p.id].viewPagerButtons ? a("#pData,#nData", k + "_2").hide() : a("#pData,#nData", k + "_2").show();
                    a(c).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + g), A]);
                    x && x.call(c, a("#" + g));
                    a("#" + a.jgrid.jqID(l.themodal)).data("onClose", b[c.p.id].onClose);
                    a.jgrid.viewModal("#" + a.jgrid.jqID(l.themodal), {gbox: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, overlay: d.overlay, modal: d.modal});
                    I || a(".jqmOverlay").click(function () {
                        if (!f())return false;
                        a.jgrid.hideModal("#" +
                            a.jgrid.jqID(l.themodal), {gb: "#gbox_" + a.jgrid.jqID(p), jqm: d.jqModal, onClose: b[c.p.id].onClose});
                        return false
                    });
                    a(c).triggerHandler("jqGridAddEditAfterShowForm", [a("#" + g), A]);
                    z && z.call(c, a("#" + g));
                    a(".fm-button", "#" + a.jgrid.jqID(l.themodal)).hover(function () {
                        a(this).addClass("ui-state-hover")
                    }, function () {
                        a(this).removeClass("ui-state-hover")
                    });
                    a("#sData", k + "_2").click(function () {
                        ...
                        a("#FormError", k).hide();
                        e();
                        if (j[c.p.id + "_id"] == "_empty")s(); else if (d.checkOnSubmit === true) {
                            F = a.extend({}, j,
                                B);
                            if (M = m(F, b[c.p.id]._savedData)) {
                                a("#" + g).data("disabled", true);
                                a(".confirm", "#" + a.jgrid.jqID(l.themodal)).show()
                            } else s()
                        } else s();
                        return false
                    });
                    ...
                    a("#nData", k + "_2").click(function () {
                        ...
                        b[0] = parseInt(b[0], 10);
                        if (b[0] != -1 && b[1][b[0] + 1]) {
                            a(c).triggerHandler("jqGridAddEditClickPgButtons",
                                ["next", a("#" + g), b[1][b[0]]]);
                            var e;
                            if (a.isFunction(d.onclickPgButtons)) {
                                e = d.onclickPgButtons.call(c, "next", a("#" + g), b[1][b[0]]);
                                if (e !== void 0 && e === false)return false
                            }
                            if (a("#" + a.jgrid.jqID(b[1][b[0] + 1])).hasClass("ui-state-disabled"))return false;
                            r(b[1][b[0] + 1], c, g);
                            a(c).jqGrid("setSelection", b[1][b[0] + 1]);
                            a(c).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a("#" + g), b[1][b[0]]]);
                            a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(c, "next", a("#" + g), b[1][b[0] + 1]);
                            o(b[0] + 1, b)
                        }
                        return false
                    });
                    a("#pData", k + "_2").click(function () {
                        ...
                        var b = w();
                        if (b[0] != -1 && b[1][b[0] - 1]) {
                            a(c).triggerHandler("jqGridAddEditClickPgButtons", ["prev", a("#" + g), b[1][b[0]]]);
                            var e;
                            if (a.isFunction(d.onclickPgButtons)) {
                                e = d.onclickPgButtons.call(c, "prev", a("#" + g), b[1][b[0]]);
                                if (e !== void 0 && e === false)return false
                            }
                            if (a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass("ui-state-disabled"))return false;
                            r(b[1][b[0] - 1], c, g);
                            a(c).jqGrid("setSelection", b[1][b[0] - 1]);
                            a(c).triggerHandler("jqGridAddEditAfterClickPgButtons",
                                ["prev", a("#" + g), b[1][b[0]]]);
                            a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(c, "prev", a("#" + g), b[1][b[0] - 1]);
                            o(b[0] - 1, b)
                        }
                        return false
                    })
    ...
    }, viewGridRow: function (v, d) {
        d = a.extend(!0, {top: 0, left: 0, width: 0, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, jqModal: !0, closeOnEscape: !1, labelswidth: "30%", closeicon: [], navkeys: [!1, 38, 40], onClose: null, beforeShowForm: null, beforeInitData: null, viewPagerButtons: !0}, a.jgrid.view, d || {});
        b[a(this)[0].p.id] = d;
        return this.each(function () {
            function e() {
                (!0 ===
                    b[m.p.id].closeOnEscape || !0 === b[m.p.id].navkeys[0]) && setTimeout(function () {
                    a(".ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(p.modalhead)).focus()
                }, 0)
            }

            function i(b, c, e, f) {
                var j, g, h, l = 0, i, k, m = [], n = !1, o, p = "<td class='CaptionTD form-view-label ui-widget-content' width='" + d.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", v = "", s = ["integer", "number", "currency"], q = 0, r = 0, x, z, w;
                for (o = 1; o <= f; o++)v += 1 == o ? p : "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                a(c.p.colModel).each(function () {
                    g = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1;
                    !g && "right" === this.align && (this.formatter && -1 !== a.inArray(this.formatter, s) ? q = Math.max(q, parseInt(this.width, 10)) : r = Math.max(r, parseInt(this.width, 10)))
                });
                x = 0 !== q ? q : 0 !== r ? r : 0;
                ...
                a(c.p.colModel).each(function (b) {
                    j = this.name;
                    z = !1;
                    k = (g = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'" : "";
                    w = "boolean" !== typeof this.viewable ? !0 :
                        this.viewable;
                    if ("cb" !== j && "subgrid" !== j && "rn" !== j && w) {
                        i = !1 === n ? "" : j == c.p.ExpandColumn && !0 === c.p.treeGrid ? a("td:eq(" + b + ")", c.rows[n]).text() : a("td:eq(" + b + ")", c.rows[n]).html();
                        z = "right" === this.align && 0 !== x ? !0 : !1;
                        var d = a.extend({}, {rowabove: !1, rowcontent: ""}, this.formoptions || {}), t = parseInt(d.rowpos, 10) || l + 1, o = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                        if (d.rowabove) {
                            var p = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + d.rowcontent + "</td></tr>");
                            a(e).append(p);
                            p[0].rp = t
                        }
                        h = a(e).find("tr[rowpos=" +
                            t + "]");
                        0 === h.length && (h = a("<tr " + k + " rowpos='" + t + "'></tr>").addClass("FormData").attr("id", "trv_" + j), a(h).append(v), a(e).append(h), h[0].rp = t);
                        a("td:eq(" + (o - 2) + ")", h[0]).html("<b>" + (void 0 === d.label ? c.p.colNames[b] : d.label) + "</b>");
                        a("td:eq(" + (o - 1) + ")", h[0]).append("<span>" + i + "</span>").attr("id", "v_" + j);
                        z && a("td:eq(" + (o - 1) + ") span", h[0]).css({"text-align": "right", width: x + "px"});
                        m[l] = b;
                        l++
                    }
                });
                0 < l && (b = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" +
                    b + "'/></td></tr>"), b[0].rp = l + 99, a(e).append(b));
                return m
            }

            function r(b, c) {
                var d, e, f = 0, h, g;
                if (g = a(c).jqGrid("getInd", b, !0))a("td", g).each(function (b) {
                    d = c.p.colModel[b].name;
                    e = c.p.colModel[b].editrules && !0 === c.p.colModel[b].editrules.edithidden ? !1 : !0 === c.p.colModel[b].hidden ? !0 : !1;
                    "cb" !== d && "subgrid" !== d && "rn" !== d && (h = d == c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(), a.extend({}, c.p.colModel[b].editoptions || {}), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + o).html(h), e && a("#" + d, "#" + o).parents("tr:first").hide(),
                        f++)
                }), 0 < f && a("#id_g", "#" + o).val(b)
            }
            ...
            function q(b, c) {
                var d = c[1].length - 1;
                0 === b ? a("#pData", "#" + o + "_2").addClass("ui-state-disabled") : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("ui-state-disabled") ? a("#pData", o + "_2").addClass("ui-state-disabled") : a("#pData", "#" + o + "_2").removeClass("ui-state-disabled");
                b == d ? a("#nData", "#" + o + "_2").addClass("ui-state-disabled") : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("ui-state-disabled") ? a("#nData", o + "_2").addClass("ui-state-disabled") :
                    a("#nData", "#" + o + "_2").removeClass("ui-state-disabled")
            }

            function s() {
                var b = a(m).jqGrid("getDataIDs"), c = a("#id_g", "#" + o).val();
                return[a.inArray(c, b), b]
            }

            var m = this;
            if (m.grid && v) {
                var f = m.p.id, h = "ViewGrid_" + a.jgrid.jqID(f), o = "ViewTbl_" + a.jgrid.jqID(f), w = "ViewGrid_" + f, c = "ViewTbl_" + f, p = {themodal: "viewmod" + f, modalhead: "viewhd" + f, modalcontent: "viewcnt" + f, scrollelm: h}, g = a.isFunction(b[m.p.id].beforeInitData) ? b[m.p.id].beforeInitData : !1, n = !0, k = 1, l = 0;
                if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                    g && (n = g.call(m,
                        a("#" + h)), void 0 === n && (n = !0));
                    if (!1 === n)return;
                    a(".ui-jqdialog-title", "#" + a.jgrid.jqID(p.modalhead)).html(d.caption);
                    a("#FormError", "#" + o).hide();
                    r(v, m);
                    a.isFunction(b[m.p.id].beforeShowForm) && b[m.p.id].beforeShowForm.call(m, a("#" + h));
                    a.jgrid.viewModal("#" + a.jgrid.jqID(p.themodal), {gbox: "#gbox_" + a.jgrid.jqID(f), jqm: d.jqModal, jqM: !1, overlay: d.overlay, modal: d.modal});
                    e()
                } else {
                    var x = isNaN(d.dataheight) ? d.dataheight : d.dataheight + "px", w = a("<form name='FormPost' id='" + w + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" +
                        x + ";'></form>"), z = a("<table id='" + c + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                    g && (n = g.call(m, a("#" + h)), void 0 === n && (n = !0));
                    if (!1 === n)return;
                    ...
                    a(w).append(z);
                    i(v, m, z, k);
                    c = "rtl" == m.p.direction ? !0 : !1;
                    g = "<a href='javascript:void(0)' id='" + (c ? "nData" : "pData") + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
                    n = "<a href='javascript:void(0)' id='" + (c ? "pData" : "nData") + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";
                    x = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bClose + "</a>";
                    if (0 < l) {
                        var y = [];
                    ...
                    d.gbox = "#gbox_" + a.jgrid.jqID(f);
                    w = a("<span></span>").append(w).append("<table border='0' class='EditTable' id='" +
                        o + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (c ? n + g : g + n) + "</td><td class='EditButton'>" + x + "</td></tr></tbody></table>");
                    a.jgrid.createModal(p, w, d, "#gview_" + a.jgrid.jqID(m.p.id), a("#gview_" + a.jgrid.jqID(m.p.id))[0]);
                    c && (a("#pData, #nData", "#" + o + "_2").css("float", "right"), a(".EditButton", "#" + o + "_2").css("text-align", "left"));
                    d.viewPagerButtons || a("#pData, #nData", "#" + o + "_2").hide();
                    w = null;
                    a("#" + p.themodal).keydown(function (c) {
                        if (c.which === 27) {
                            b[m.p.id].closeOnEscape &&
                            a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {gb: d.gbox, jqm: d.jqModal, onClose: d.onClose});
                            return false
                        }
                        if (d.navkeys[0] === true) {
                    ...
                    d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon);
                    !0 === d.closeicon[0] && a("#cData", "#" + o + "_2").addClass("right" == d.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " +
                        d.closeicon[2] + "'></span>");
                    a.isFunction(d.beforeShowForm) && d.beforeShowForm.call(m, a("#" + h));
                    a.jgrid.viewModal("#" + a.jgrid.jqID(p.themodal), {gbox: "#gbox_" + a.jgrid.jqID(f), jqm: d.jqModal, modal: d.modal});
                    a(".fm-button:not(.ui-state-disabled)", "#" + o + "_2").hover(function () {
                        a(this).addClass("ui-state-hover")
                    }, function () {
                        a(this).removeClass("ui-state-hover")
                    });
                    ...
                    a("#cData", "#" + o + "_2").click(function () {
                        a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {gb: "#gbox_" + a.jgrid.jqID(f), jqm: d.jqModal, onClose: d.onClose});
                        return false
                    });
                    a("#nData", "#" + o + "_2").click(function () {
                        ...
                        b[0] = parseInt(b[0], 10);
                        if (b[0] != -1 && b[1][b[0] + 1]) {
                            a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(m, "next", a("#" + h), b[1][b[0]]);
                            r(b[1][b[0] + 1], m);
                            a(m).jqGrid("setSelection", b[1][b[0] + 1]);
                            a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(m, "next", a("#" + h), b[1][b[0] + 1]);
                            q(b[0] + 1, b)
                        }
                        e();
                        return false
                    ...
                    a("#pData", "#" + o + "_2").click(function () {
                        ...
                        var b = s();
                        if (b[0] != -1 && b[1][b[0] - 1]) {
                            a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(m, "prev", a("#" + h), b[1][b[0]]);
                            r(b[1][b[0] - 1], m);
                            a(m).jqGrid("setSelection", b[1][b[0] - 1]);
                            a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(m, "prev", a("#" + h), b[1][b[0] - 1]);
                            q(b[0] - 1, b)
                        }
                        e();
                        return false
    ...
    }, delGridRow: function (v, d) {
        d = a.extend(!0, {top: 0, left: 0, width: 240, height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: "", mtype: "POST", reloadAfterSubmit: !0, beforeShowForm: null,
            beforeInitData: null, afterShowForm: null, beforeSubmit: null, onclickSubmit: null, afterSubmit: null, jqModal: !0, closeOnEscape: !1, delData: {}, delicon: [], cancelicon: [], onClose: null, ajaxDelOptions: {}, processing: !1, serializeDelData: null, useDataProxy: !1}, a.jgrid.del, d || {});
        b[a(this)[0].p.id] = d;
        return this.each(function () {
            var e = this;
            if (e.grid && v) {
                var i = a.isFunction(b[e.p.id].beforeShowForm), r = a.isFunction(b[e.p.id].afterShowForm), q = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, s = e.p.id, m = {},
                    f = !0, h = "DelTbl_" + a.jgrid.jqID(s), o, w, c, p, g = "DelTbl_" + s, n = {themodal: "delmod" + s, modalhead: "delhd" + s, modalcontent: "delcnt" + s, scrollelm: h};
                a.isArray(v) && (v = v.join());
                if (void 0 !== a("#" + a.jgrid.jqID(n.themodal))[0]) {
                    q && (f = q.call(e, a("#" + h)), void 0 === f && (f = !0));
                    if (!1 === f)return;
                    a("#DelData>td", "#" + h).text(v);
                    a("#DelError", "#" + h).hide();
                    !0 === b[e.p.id].processing && (b[e.p.id].processing = !1, a("#dData", "#" + h).removeClass("ui-state-active"));
                    i && b[e.p.id].beforeShowForm.call(e, a("#" + h));
                    a.jgrid.viewModal("#" + a.jgrid.jqID(n.themodal),
                        {gbox: "#gbox_" + a.jgrid.jqID(s), jqm: b[e.p.id].jqModal, jqM: !1, overlay: b[e.p.id].overlay, modal: b[e.p.id].modal})
                } else {
                    var k = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px", g = "<div id='" + g + "' class='formdata' style='width:100%;overflow:auto;position:relative;height:" + k + ";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>" + ("<tr id='DelData' style='display:none'><td >" + v + "</td></tr>"), g = g + ('<tr><td class="delmsg" style="white-space:pre;">' +
                    ...
                    a.jgrid.createModal(n, g, d, "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]);
                    q && (f = q.call(e, a("#" + h)), void 0 === f && (f = !0));
                    if (!1 === f)return;
                    a(".fm-button", "#" + h + "_2").hover(function () {
                        a(this).addClass("ui-state-hover")
                    }, function () {
                        a(this).removeClass("ui-state-hover")
                    });
                    d.delicon = a.extend([!0, "left", "ui-icon-scissors"], b[e.p.id].delicon);
                    d.cancelicon = a.extend([!0, "left", "ui-icon-cancel"], b[e.p.id].cancelicon);
                    !0 ===
                        d.delicon[0] && a("#dData", "#" + h + "_2").addClass("right" == d.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.delicon[2] + "'></span>");
                    !0 === d.cancelicon[0] && a("#eData", "#" + h + "_2").addClass("right" == d.cancelicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.cancelicon[2] + "'></span>");
                    a("#dData", "#" + h + "_2").click(function () {
                        var f = [true, ""], g, i = a("#DelData>td", "#" + h).text();
                        m = {};
                        a.isFunction(b[e.p.id].onclickSubmit) && (m = b[e.p.id].onclickSubmit.call(e,
                            b[e.p.id], i) || {});
                        a.isFunction(b[e.p.id].beforeSubmit) && (f = b[e.p.id].beforeSubmit.call(e, i));
                        if (f[0] && !b[e.p.id].processing) {
                            b[e.p.id].processing = true;
                            c = e.p.prmNames;
                            o = a.extend({}, b[e.p.id].delData, m);
                            p = c.oper;
                            o[p] = c.deloper;
                            w = c.id;
                            i = ("" + i).split(",");
                            if (!i.length)return false;
                            for (g in i)i.hasOwnProperty(g) && (i[g] = a.jgrid.stripPref(e.p.idPrefix, i[g]));
                            o[w] = i.join();
                            a(this).addClass("ui-state-active");
                            g = a.extend({url: b[e.p.id].url || a(e).jqGrid("getGridParam", "editurl"), type: b[e.p.id].mtype, data: a.isFunction(b[e.p.id].serializeDelData) ?
                                b[e.p.id].serializeDelData.call(e, o) : o, complete: function (c, g) {
                                var k;
                                if (g != "success") {
                                    f[0] = false;
                                    f[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : g + " Status: '" + c.statusText + "'. Error code: " + c.status
                                } else a.isFunction(b[e.p.id].afterSubmit) && (f = b[e.p.id].afterSubmit.call(e, c, o));
                                if (f[0] === false) {
                                    a("#DelError>td", "#" + h).html(f[1]);
                                    a("#DelError", "#" + h).show()
                                } else {
                                    ...
                                    a.isFunction(b[e.p.id].afterComplete) && setTimeout(function () {
                                        b[e.p.id].afterComplete.call(e, c, i)
                                    }, 500)
                                }
                                b[e.p.id].processing = false;
                                a("#dData", "#" + h + "_2").removeClass("ui-state-active");
                                f[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" + a.jgrid.jqID(s), jqm: d.jqModal, onClose: b[e.p.id].onClose})
                            ...
                            if (f[0])if (b[e.p.id].useDataProxy) {
                                ...
                                } else a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" + a.jgrid.jqID(s), jqm: d.jqModal, onClose: b[e.p.id].onClose})
                            } else a.ajax(g)
                        }
                        if (f[0] === false) {
                            a("#DelError>td", "#" + h).html(f[1]);
                    ...
                    a("#eData", "#" + h + "_2").click(function () {
                        a.jgrid.hideModal("#" + a.jgrid.jqID(n.themodal), {gb: "#gbox_" + a.jgrid.jqID(s), jqm: b[e.p.id].jqModal, onClose: b[e.p.id].onClose});
                        return false
                    });
                    i && b[e.p.id].beforeShowForm.call(e, a("#" + h));
                    a.jgrid.viewModal("#" + a.jgrid.jqID(n.themodal), {gbox: "#gbox_" + a.jgrid.jqID(s), jqm: b[e.p.id].jqModal, overlay: b[e.p.id].overlay, modal: b[e.p.id].modal})
                }
                r && b[e.p.id].afterShowForm.call(e, a("#" + h));
                !0 === b[e.p.id].closeOnEscape && setTimeout(function () {
                    a(".ui-jqdialog-titlebar-close",
                        "#" + a.jgrid.jqID(n.modalhead)).focus()
                }, 0)
            }
        })
    }, navGrid: function (b, d, e, i, r, q, s) {
        ...
        return this.each(function () {
            if (!this.nav) {
                var m = {themodal: "alertmod_" + this.p.id, modalhead: "alerthd_" + this.p.id, modalcontent: "alertcnt_" + this.p.id}, f = this, h;
                if (f.grid && "string" === typeof b) {
                    void 0 === a("#" + m.themodal)[0] && (!d.alerttop && !d.alertleft && (void 0 !== window.innerWidth ? (d.alertleft = window.innerWidth, d.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (d.alertleft = document.documentElement.clientWidth,
                        ...
                        a.jgrid.jqID(f.p.id), a("#gbox_" + a.jgrid.jqID(f.p.id))[0], !0));
                    var o = 1, w, c = function () {
                        a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                    }, p = function () {
                        a(this).removeClass("ui-state-hover")
                    };
                    d.cloneToTop && f.p.toppager && (o = 2);
                    for (w = 0; w < o; w++) {
                        var g = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"), n, k;
                        0 === w ? (n = b, k = f.p.id, n == f.p.toppager && (k += "_top", o = 1)) : (n = f.p.toppager, k = f.p.id +
                            "_top");
                        "rtl" == f.p.direction && a(g).attr("dir", "rtl").css("float", "right");
                        d.add && (i = i || {}, h = a("<td class='ui-pg-button ui-corner-all'></td>"), a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.addicon + "'></span>" + d.addtext + "</div>"), a("tr", g).append(h), a(h, g).attr({title: d.addtitle || "", id: i.id || "add_" + k}).click(function () {
                            a(this).hasClass("ui-state-disabled") || (a.isFunction(d.addfunc) ? d.addfunc.call(f) : a(f).jqGrid("editGridRow", "new", i));
                            return false
                        }).hover(c, p), h = null);
                        d.edit && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            e = e || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", g).append(h), a(h, g).attr({title: d.edittitle || "", id: e.id || "edit_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b = f.p.selrow;
                                if (b)a.isFunction(d.editfunc) ? d.editfunc.call(f, b) : a(f).jqGrid("editGridRow", b, e); else {
                                    a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" + a.jgrid.jqID(f.p.id), jqm: true});
                                    a("#jqg_alrt").focus()
                                }
                            }
                            return false
                        }).hover(c, p), h = null);
                        d.view && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            s = s || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.viewicon + "'></span>" + d.viewtext + "</div>"), a("tr", g).append(h), a(h, g).attr({title: d.viewtitle || "", id: s.id || "view_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b = f.p.selrow;
                                if (b)a.isFunction(d.viewfunc) ? d.viewfunc.call(f, b) : a(f).jqGrid("viewGridRow", b, s); else {
                                    a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" + a.jgrid.jqID(f.p.id), jqm: true});
                                    a("#jqg_alrt").focus()
                                }
                            }
                        ...
                        d.del && (h = a("<td class='ui-pg-button ui-corner-all'></td>"),
                            r = r || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", g).append(h), a(h, g).attr({title: d.deltitle || "", id: r.id || "del_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                var b;
                                if (f.p.multiselect) {
                                    b = f.p.selarrrow;
                                ...
                                if (b)a.isFunction(d.delfunc) ? d.delfunc.call(f, b) : a(f).jqGrid("delGridRow", b, r); else {
                                    a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" + a.jgrid.jqID(f.p.id), jqm: true});
                                    a("#jqg_alrt").focus()
                                }
                            }
                            ...
                            p), h = null);
                        (d.add || d.edit || d.del || d.view) && a("tr", g).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
                        d.search && (h = a("<td class='ui-pg-button ui-corner-all'></td>"), q = q || {}, a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", g).append(h), a(h, g).attr({title: d.searchtitle || "", id: q.id || "search_" + k}).click(function () {
                            a(this).hasClass("ui-state-disabled") || (a.isFunction(d.searchfunc) ?
                                d.searchfunc.call(f, q) : a(f).jqGrid("searchGrid", q));
                            return false
                        }).hover(c, p), q.showOnLoad && !0 === q.showOnLoad && a(h, g).click(), h = null);
                        d.refresh && (h = a("<td class='ui-pg-button ui-corner-all'></td>"), a(h).append("<div class='ui-pg-div'><span class='ui-icon " + d.refreshicon + "'></span>" + d.refreshtext + "</div>"), a("tr", g).append(h), a(h, g).attr({title: d.refreshtitle || "", id: "refresh_" + k}).click(function () {
                            if (!a(this).hasClass("ui-state-disabled")) {
                                a.isFunction(d.beforeRefresh) && d.beforeRefresh.call(f);
                                f.p.search =
                                    false;
                                try {
                                    var b = f.p.id;
                        ...
                        a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" +
                            h + ";visibility:hidden;' ></div>");
                        h = a(g).clone().appendTo("#testpg2").width();
                        a("#testpg2").remove();
                        a(n + "_" + d.position, n).append(g);
                        f.p._nvtd && (h > f.p._nvtd[0] && (a(n + "_" + d.position, n).width(h), f.p._nvtd[0] = h), f.p._nvtd[1] = h);
                        g = h = h = null;
                        this.nav = !0
                    }
                }
        ...
        return this.each(function () {
            if (this.grid) {
                ...
                if (e && !(d.id && void 0 !== a("#" + a.jgrid.jqID(d.id), e)[0])) {
                    ...
                    a(r, e).attr("title", d.title || "").click(function (b) {
                        a(this).hasClass("ui-state-disabled") || a.isFunction(d.onClickButton) && d.onClickButton.call(i, b);
                        return!1
                    }).hover(function () {
                        a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                    }, function () {
    ...
    }, navSeparatorAdd: function (b, d) {
        d = a.extend({sepclass: "ui-separator", sepcontent: "", position: "last"}, d || {});
        return this.each(function () {
            if (this.grid) {
                "string" === typeof b &&
                    0 !== b.indexOf("#") && (b = "#" + a.jgrid.jqID(b));
                var e = a(".navtable", b)[0];
                if (e) {
                    var i = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='" + d.sepclass + "'></span>" + d.sepcontent + "</td>";
                    "first" === d.position ? 0 === e.rows[0].cells.length ? a("tr", e).append(i) : a("tr td:eq(0)", e).before(i) : a("tr", e).append(i)
                }
            }
        })
    }, GridToForm: function (b, d) {
        return this.each(function () {
            var e = this, i;
            if (e.grid) {
                var r = a(e).jqGrid("getRowData", b);
                if (r)for (i in r)r.hasOwnProperty(i) && (a("[name=" + a.jgrid.jqID(i) +
                    "]", d).is("input:radio") || a("[name=" + a.jgrid.jqID(i) + "]", d).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(i) + "]", d).each(function () {
                    if (a(this).val() == r[i])a(this)[e.p.useProp ? "prop" : "attr"]("checked", !0); else a(this)[e.p.useProp ? "prop" : "attr"]("checked", !1)
                }) : a("[name=" + a.jgrid.jqID(i) + "]", d).val(r[i]))
            }
        })
    }, FormToGrid: function (b, d, e, i) {
        return this.each(function () {
            if (this.grid) {
                e || (e = "set");
                i || (i = "first");
                var r = a(d).serializeArray(), q = {};
                a.each(r, function (a, b) {
                    q[b.name] = b.value
                });
                "add" == e ? a(this).jqGrid("addRowData",
                    b, q, i) : "set" == e && a(this).jqGrid("setRowData", b, q)
            }
        })
    }})
})(jQuery);
(function (a) {
    a.fn.jqFilter = function (d) {
        ...
        var p = a.extend(!0, {filter: null, columns: [], onChange: null, afterRedraw: null, checkValues: null, error: !1, errmsg: "", errorcheck: !0, showQuery: !0, sopt: null, ops: [
        ...
        ], numopts: "eq,ne,lt,le,gt,ge,nu,nn,in,ni".split(","), stropts: "eq,ne,bw,bn,ew,en,cn,nc,nu,nn,in,ni".split(","), strarr: ["text", "string", "blob"], _gridsopt: [], groupOps: [
            {op: "AND", text: "AND"},
            {op: "OR", text: "OR"}
        ...
        return this.each(function () {
            if (!this.filter) {
                this.p = p;
                if (null ===
                    this.p.filter || void 0 === this.p.filter)this.p.filter = {groupOp: this.p.groupOps[0].op, rules: [], groups: []};
                ...
                if (n) {
                    for (d = 0; d < n; d++)if (f = this.p.columns[d], f.stype ? f.inputtype = f.stype : f.inputtype || (f.inputtype = "text"), f.sorttype ? f.searchtype = f.sorttype : f.searchtype ||
                    ...
                    var r = function (g, k) {
                        var b = [!0, ""];
                        if (a.isFunction(k.searchrules))b =
                            k.searchrules(g, k); else if (a.jgrid && a.jgrid.checkValues)try {
                    ...
                    this.createTableForGroup = function (g, k) {
                        var b = this, c, e = a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"), d = "left";
                        ...
                        this.p.groupButton && (h = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"), h.bind("click", function () {
                            ...
                            g.groups.push({groupOp: p.groupOps[0].op, rules: [], groups: []});
                            b.reDraw();
                            b.onchange();
                            return false
                        }));
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            h.bind("click", function () {
                                ...
                                for (c = 0; c < b.p.columns.length; c++) {
                                    var e = b.p.columns[c].search === void 0 ? true : b.p.columns[c].search, d = b.p.columns[c].hidden === true;
                                    if (b.p.columns[c].searchoptions.searchhidden === true && e || e && !d) {
                                        l = b.p.columns[c];
                                        break
                                    }
                                }
                                e = l.searchoptions.sopt ? l.searchoptions.sopt : b.p.sopt ? b.p.sopt :
                                    a.inArray(l.searchtype, b.p.strarr) !== -1 ? b.p.stropts : b.p.numopts;
                                g.rules.push({field: l.name, op: e[0], data: ""});
                                b.reDraw();
                                return false
                            });
                            d.append(h)
                        ...
                        if (void 0 !== g.groups)for (c = 0; c < g.groups.length; c++)d = a("<tr></tr>"), e.append(d), h = a("<td class='first'></td>"),
                            d.append(h), h = a("<td colspan='4'></td>"), h.append(this.createTableForGroup(g.groups[c], g)), d.append(h);
                    ...
                    this.createTableRowForRule = function (g, d) {
                        ...
                        n.bind("change", function () {
                            ...
                            if (i) {
                                ...
                                a.browser.msie && 9 > a.browser.version && (d = parseInt(a("select.selectopts", h)[0].offsetWidth, 10) + 1, a(".selectopts", h).width(d), a(".selectopts", h).css("width", "auto"));
                                a(".data", h).empty().append(c);
                                a.jgrid.bindEv(c, i.searchoptions,
                                    b);
                        ...
                        i.searchoptions.id = a.jgrid.randId();
                        t && "text" === i.inputtype && !i.searchoptions.size && (i.searchoptions.size = 10);
                        m = a.jgrid.createEl(i.inputtype, i.searchoptions, g.data, !0, b.p.ajaxSelectOptions,
                            !0);
                        ...
                        f = i.searchoptions.sopt ? i.searchoptions.sopt : b.p.sopt ? b.p.sopt :
                            -1 !== a.inArray(i.searchtype, b.p.strarr) ? b.p.stropts : b.p.numopts;
                        j = "";
                        a.each(b.p.ops, function () {
                            q.push(this.name)
                        });
                        ...
                        a(m).addClass("input-elm").bind("change", function () {
                            g.data = i.inputtype === "custom" ? i.searchoptions.custom_value(a(this).children(".customelement:first"),
                                "get") : a(this).val();
                            b.onchange()
                        });
                        j = a("<td></td>");
...
(function (a) {
    ...
    a.jgrid.extend({editRow: function (b, c, e, o, l, g, n, i, f) {
        var j = {}, d = a.makeArray(arguments).slice(1);
        if ("object" === a.type(d[0]))j = d[0]; else if (void 0 !== c && (j.keys = c), a.isFunction(e) && (j.oneditfunc = e), a.isFunction(o) && (j.successfunc = o), void 0 !== l && (j.url = l), void 0 !== g && (j.extraparam = g), a.isFunction(n) && (j.aftersavefunc = n), a.isFunction(i) && (j.errorfunc = i), a.isFunction(f))j.afterrestorefunc = f;
        ...
        return this.each(function () {
            var d = this, c, f, e = 0, i = null, l = {}, g, k;
            if (d.grid && (g = a(d).jqGrid("getInd", b, !0), !1 !== g && "0" == (a(g).attr("editable") || "0") && !a(g).hasClass("not-editable-row")))k = d.p.colModel, a('td[role="gridcell"]', g).each(function (g) {
                ...
                if (j)f = a("span:first", this).html(); else try {
                    f = a.unformat.call(d, this, {rowId: b,
                        colModel: k[g]}, g)
                } catch (o) {
                ...
                if ("cb" != c && "subgrid" != c && "rn" != c && (d.p.autoencode && (f = a.jgrid.htmlDecode(f)), l[c] = f, !0 === k[g].editable)) {
                    ...
                    var x = a.extend({}, k[g].editoptions || {}, {id: b + "_" + c, name: c});
                    k[g].edittype || (k[g].edittype = "text");
                    if ("&nbsp;" == f || "&#160;" == f || 1 == f.length && 160 == f.charCodeAt(0))f = "";
                    var v = a.jgrid.createEl.call(d, k[g].edittype, x, f, !0, a.extend({}, a.jgrid.ajaxOptions,
                        d.p.ajaxSelectOptions || {}));
                    a(v).addClass("editable");
                    j ? a("span:first", this).append(v) : a(this).append(v);
                    a.jgrid.bindEv(v, x, d);
                    "select" == k[g].edittype && void 0 !== k[g].editoptions && !0 === k[g].editoptions.multiple && void 0 === k[g].editoptions.dataUrl && a.browser.msie && a(v).width(a(v).width());
                    e++
                }
        ...
        var i = a.makeArray(arguments).slice(1), f = {};
        if ("object" === a.type(i[0]))f = i[0]; else if (a.isFunction(c) && (f.successfunc = c), void 0 !== e && (f.url = e), void 0 !== o && (f.extraparam = o), a.isFunction(l) && (f.aftersavefunc = l),
            a.isFunction(g) && (f.errorfunc = g), a.isFunction(n))f.afterrestorefunc = n;
        var f = a.extend(!0, {successfunc: null, url: null, extraparam: {}, aftersavefunc: null, errorfunc: null, afterrestorefunc: null, restoreAfterError: !0, mtype: "POST"}, a.jgrid.inlineEdit, f), j = !1, d = this[0], m, h = {}, w = {}, r = {}, t, s, q;
        if (!d.grid)return j;
        ...
        if ("1" === i) {
            ...
            a('td[role="gridcell"]', q).each(function (b) {
                ...
                m = k.name;
                if ("cb" != m && "subgrid" !=
                    m && !0 === k.editable && "rn" != m && !a(this).hasClass("not-editable-cell")) {
                    switch (k.edittype) {
                        case "checkbox":
                            var c = ["Yes", "No"];
            ...
            var p = d.p.prmNames, u = b, i = !1 === d.p.keyIndex ? p.id : d.p.colModel[d.p.keyIndex + (!0 === d.p.rownumbers ? 1 : 0) + (!0 === d.p.multiselect ? 1 : 0) + (!0 === d.p.subGrid ? 1 : 0)].name;
            if (h) {
                h[p.oper] = p.editoper;
                if (void 0 === h[i])h[i] = b; else if (q.id !== d.p.idPrefix + h[i] && (p = a.jgrid.stripPref(d.p.idPrefix, b), void 0 !== d.p._index[p] && (d.p._index[h[i]] = d.p._index[p], delete d.p._index[p]), b = d.p.idPrefix + h[i], a(q).attr("id", b), d.p.selrow === u && (d.p.selrow = b), a.isArray(d.p.selarrrow) &&
                    (p = a.inArray(u, d.p.selarrrow), 0 <= p && (d.p.selarrrow[p] = b)), d.p.multiselect))p = "jqg_" + d.p.id + "_" + b, a("input.cbox", q).attr("id", p).attr("name", p);
            ...
            if ("clientArray" == f.url) {
                ...
                0 <= t && d.p.savedRow.splice(t,
                    1);
                a(d).triggerHandler("jqGridInlineAfterSaveRow", [b, p, h, f]);
                a.isFunction(f.aftersavefunc) && f.aftersavefunc.call(d, b, p, f);
                j = !0;
                a(q).unbind("keydown")
            } else a("#lui_" + a.jgrid.jqID(d.p.id)).show(), r = a.extend({}, h, r), r[i] = a.jgrid.stripPref(d.p.idPrefix, r[i]), a.ajax(a.extend({url: f.url, data: a.isFunction(d.p.serializeRowData) ? d.p.serializeRowData.call(d, r) : r, type: f.mtype, async: !1, complete: function (c, g) {
                a("#lui_" + a.jgrid.jqID(d.p.id)).hide();
                if ("success" === g) {
                    var e = !0, i;
                    i = a(d).triggerHandler("jqGridInlineSuccessSaveRow",
                        [c, b, f]);
                    a.isArray(i) || (i = [!0, h]);
                    ...
                    if (!0 === e) {
                        ...
                        a.isFunction(f.aftersavefunc) && f.aftersavefunc.call(d, b,
                            c);
                        j = !0;
                        a(q).unbind("keydown")
                ...
                if (a.isFunction(f.errorfunc))f.errorfunc.call(d, b, c, e, g); else {
                    c = c.responseText || c.statusText;
                    try {
                        a.jgrid.info_dialog(a.jgrid.errors.errcap, '<div class="ui-state-error">' +
                            c + "</div>", a.jgrid.edit.bClose, {buttonalign: "right"})
                    } catch (i) {
                        alert(c)
                    }
                }
        ...
        return this.each(function () {
            ...
            if (c.grid) {
                ...
                if (n !== false) {
                    for (f = 0; f < c.p.savedRow.length; f++)if (c.p.savedRow[f].id ==
                        b) {
                        e = f;
                        break
                    }
        ...
        b = a.extend(!0, {rowID: null, initdata: {}, position: "first", useDefValues: !0, useFormatter: !1, addRowParams: {extraparam: {}}}, b || {});
        return this.each(function () {
            if (this.grid) {
                var c = this;
                ...
                if (b.useFormatter)a("#" + a.jgrid.jqID(b.rowID) + " .ui-inline-edit", "#" + a.jgrid.jqID(c.p.id)).click(); else {
                    var e = c.p.prmNames;
        ...
        inlineNav: function (b, c) {
            c = a.extend({edit: !0, editicon: "ui-icon-pencil", add: !0, addicon: "ui-icon-plus", save: !0, saveicon: "ui-icon-disk", cancel: !0, cancelicon: "ui-icon-cancel", addParams: {}, editParams: {}, restoreAfterSelect: !0}, a.jgrid.nav, c || {});
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (!0 === c.addParams.useFormatter) {
                        ...
                        for (n = 0; n < g.length; n++)if (g[n].formatter && "actions" === g[n].formatter) {
                            g[n].formatoptions && (g = a.extend({keys: !1,
                    ...
                    c.add && a(e).jqGrid("navButtonAdd", b, {caption: c.addtext, title: c.addtitle, buttonicon: c.addicon, id: e.p.id + "_iladd", onClickButton: function () {
                        a(e).jqGrid("addRow", c.addParams);
                        c.addParams.useFormatter ||
                        (a("#" + l + "_ilsave").removeClass("ui-state-disabled"), a("#" + l + "_ilcancel").removeClass("ui-state-disabled"), a("#" + l + "_iladd").addClass("ui-state-disabled"), a("#" + l + "_iledit").addClass("ui-state-disabled"))
                    }});
                    c.edit && a(e).jqGrid("navButtonAdd", b, {caption: c.edittext, title: c.edittitle, buttonicon: c.editicon, id: e.p.id + "_iledit", onClickButton: function () {
                        var b = a(e).jqGrid("getGridParam", "selrow");
                        b ? (a(e).jqGrid("editRow", b, c.editParams), a("#" + l + "_ilsave").removeClass("ui-state-disabled"), a("#" + l + "_ilcancel").removeClass("ui-state-disabled"),
                            a("#" + l + "_iladd").addClass("ui-state-disabled"), a("#" + l + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + l, jqm: !0}), a("#jqg_alrt").focus())
                    }});
                    c.save && (a(e).jqGrid("navButtonAdd", b, {caption: c.savetext || "", title: c.savetitle || "Save row", buttonicon: c.saveicon, id: e.p.id + "_ilsave", onClickButton: function () {
                        var b = e.p.savedRow[0].id;
                        if (b) {
                            var f = e.p.prmNames, g = f.oper;
                            c.editParams.extraparam || (c.editParams.extraparam = {});
                            c.editParams.extraparam[g] = a("#" + a.jgrid.jqID(b),
                                "#" + l).hasClass("jqgrid-new-row") ? f.addoper : f.editoper;
                            a(e).jqGrid("saveRow", b, c.editParams) && a(e).jqGrid("showAddEditButtons")
                        } else a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + l, jqm: !0}), a("#jqg_alrt").focus()
                    }}), a("#" + l + "_ilsave").addClass("ui-state-disabled"));
                    c.cancel && (a(e).jqGrid("navButtonAdd", b, {caption: c.canceltext || "", title: c.canceltitle || "Cancel row editing", buttonicon: c.cancelicon, id: e.p.id + "_ilcancel", onClickButton: function () {
                        var b = e.p.savedRow[0].id;
                        if (b) {
                            a(e).jqGrid("restoreRow", b,
                                c.editParams);
                            a(e).jqGrid("showAddEditButtons")
                        } else {
                            a.jgrid.viewModal("#alertmod", {gbox: "#gbox_" + l, jqm: true});
                            a("#jqg_alrt").focus()
                        }
                    ...
                    !0 === c.restoreAfterSelect && (o = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow : !1, e.p.beforeSelectRow = function (b, f) {
                        ...
                        if (e.p.savedRow.length > 0 && e.p._inlinenav === true && b !== e.p.selrow && e.p.selrow !== null) {
                            e.p.selrow == c.addParams.rowID ? a(e).jqGrid("delRowData", e.p.selrow) : a(e).jqGrid("restoreRow", e.p.selrow,
                                c.editParams);
                            a(e).jqGrid("showAddEditButtons")
                        }
                        o && (g = o.call(e, b, f));
    ...
    b.jgrid.extend({editCell: function (d, f, a) {
            ...
            if (c.grid && !0 === c.p.cellEdit) {
                ...
                if (!("subgrid" == g || "cb" == g || "rn" == g)) {
                    ...
                    if (!0 === i.editable && !0 === a && !h.hasClass("not-editable-cell")) {
                        ...
                        b(c.rows[d]).addClass("selected-row ui-state-hover"), e = h.html().replace(/\&#160\;/ig, ""), b(c).triggerHandler("jqGridSelectCell", [c.rows[d].id, g, e, d, f]), b.isFunction(c.p.onSelectCell) && c.p.onSelectCell.call(c, c.rows[d].id, g, e, d, f);
                    c.p.iCol = f;
                    c.p.iRow = d
                }
            }
        ...
        return this.each(function () {
            ...
            if (a.grid && !0 === a.p.cellEdit) {
                ...
                if (null !== c) {
                    var g = b("td:eq(" + f + ")", a.rows[d]), e, h, i = a.p.colModel[f], k = i.name, j = b.jgrid.jqID(k);
                    switch (i.edittype) {
                        case "select":
                        ...
                        case "custom":
                            try {
                                ...
                                "e1" == o && b.jgrid.info_dialog(b.jgrid.errors.errcap, "function 'custom_value' " + b.jgrid.edit.msg.nodefined, b.jgrid.edit.bClose), "e2" == o ? b.jgrid.info_dialog(b.jgrid.errors.errcap, "function 'custom_value' " + b.jgrid.edit.msg.novalue, b.jgrid.edit.bClose) : b.jgrid.info_dialog(b.jgrid.errors.errcap, o.message,
                                    b.jgrid.edit.bClose)
                            }
                    }
                        ...
                        if (!0 === p[0]) {
                            ...
                            if ("remote" == a.p.cellsubmit)if (a.p.cellurl) {
                                ...
                                b.ajax(b.extend({url: a.p.cellurl, data: b.isFunction(a.p.serializeCellData) ? a.p.serializeCellData.call(a, m) : m, type: "POST", complete: function (c, i) {
                                    ...
                                    if (i == "success") {
                                        var j =
                                            b(a).triggerHandler("jqGridAfterSubmitCell", [a, c, m.id, k, e, d, f]) || [true, ""];
                ...
                b.browser.opera ? b("#" + b.jgrid.jqID(a.p.knv)).attr("tabindex", "-1").focus() : window.setTimeout(function () {
        ...
        return this.each(function () {
            ...
            if (a.grid && !0 === a.p.cellEdit) {
                a.p.knv = a.p.id + "_kn";
                var c = b("<div style='position:fixed;top:-1000000px;width:1px;height:1px;' tabindex='0'><div tabindex='-1' style='width:1px;height:1px;' id='" +
                    a.p.knv + "'></div></div>"), g, e;
...
(function (b) {
    b.fn.jqm = function (a) {
        ...
        return this.each(function () {
            ...
            g++;
            this._jqm = g;
            i[g] = {c: b.extend(k, b.jqm.params, a), a: d, w: b(this).addClass("jqmID" + g), s: g};
    ...
    b.jqm = {hash: {}, open: function (a, k) {
        var c = i[a], e = c.c, l = "." + e.closeClass, h = parseInt(c.w.css("z-index")), h = 0 < h ? h : 3E3, f = b("<div></div>").css({height: "100%", width: "100%", position: "fixed", left: 0, top: 0, "z-index": h - 1, opacity: e.overlay / 100});
        if (c.a)return d;
        c.t = k;
        c.a = !0;
        c.w.css("z-index", h);
        e.modal ? (j[0] || setTimeout(function () {
            ...
            1), j.push(a)) : 0 < e.overlay ? e.closeoverlay && c.w.jqmAddClose(f) : f = d;
        c.o = f ? f.addClass(e.overlayClass).prependTo("body") : d;
        if (p)try {
            if (b("html,body").css({height: "100%", width: "100%"}), f) {
                var f = f.css({position: "absolute"})[0], g;
                for (g in{Top: 1, Left: 1})f.style.setExpression(g.toLowerCase(), "(_=(document.documentElement.scroll" + g + " || document.body.scroll" + g + "))+'px'")
            }
        } catch (m) {
        }
        e.ajax ? (h = e.target || c.w, f = e.ajax, h = "string" == typeof h ? b(h, c.w) : b(h), f = "@" == f.substr(0, 1) ? b(k).attr(f.substring(1)) : f, h.html(e.ajaxText).load(f,
            function () {
    ...
    var g = 0, i = b.jqm.hash, j = [], p = b.browser.msie &&
        "6.0" == b.browser.version, d = !1, q = function (a) {
        var d = b('<iframe src="javascript:false;document.write(\'\');" class="jqm"></iframe>').css({opacity: 0});
        p && (a.o ? a.o.html('<p style="width:100%;height:100%"/>').prepend(d) : b("iframe.jqm", a.w)[0] || a.w.prepend(d));
        r(a)
    }, r = function (a) {
        try {
        ...
        b(document)[a]("keypress", m)[a]("keydown", m)[a]("mousedown", m)
    }, m = function (a) {
        var d = i[j[j.length - 1]];
        (a = !b(a.target).parents(".jqmID" + d.s)[0]) && r(d);
        return!a
    }, n = function (a, g, c) {
        return a.each(function () {
            ...
            b(g).each(function () {
                this[c] || (this[c] = [], b(this).click(function () {
                    for (var a in{jqmShow: 1, jqmHide: 1})for (var b in this[a])if (i[this[a][b]])i[this[a][b]].w[a](this);
                    return d
                }));
                this[c].push(a)
            })
...
(function (b) {
    b.jgrid.extend({setSubGrid: function () {
        return this.each(function () {
            ...
            this.p.colModel.unshift({name: "subgrid", width: b.browser.safari || b.browser.webkit ? this.p.subGridWidth + this.p.cellLayout : this.p.subGridWidth, sortable: !1, resizable: !1, hidedlg: !0, search: !1,
                fixed: !0});
...
(function (c) {
    c.extend(c.jgrid, {template: function (d) {
        var h = c.makeArray(arguments).slice(1), e, a = h.length;
        null == d && (d = "");
    ...
    c.jgrid.extend({groupingSetup: function () {
        return this.each(function () {
            var d, h, e = this.p.colModel, a = this.p.groupingView;
            if (null !== a && ("object" === typeof a ||
                c.isFunction(a)))if (a.groupField.length) {
                void 0 === a.visibiltyOnNextGrouping && (a.visibiltyOnNextGrouping = []);
                a.lastvalues = [];
                a.groups = [];
                a.counters = [];
                for (d = 0; d < a.groupField.length; d++)a.groupOrder[d] || (a.groupOrder[d] = "asc"), a.groupText[d] || (a.groupText[d] = "{0}"), "boolean" !== typeof a.groupColumnShow[d] && (a.groupColumnShow[d] = !0), "boolean" !== typeof a.groupSummary[d] && (a.groupSummary[d] = !1), !0 === a.groupColumnShow[d] ? (a.visibiltyOnNextGrouping[d] = !0, c(this).jqGrid("showCol", a.groupField[d])) : (a.visibiltyOnNextGrouping[d] =
                    c("#" + c.jgrid.jqID(this.p.id + "_" + a.groupField[d])).is(":visible"), c(this).jqGrid("hideCol", a.groupField[d]));
                a.summary = [];
                d = 0;
                for (h = e.length; d < h; d++)e[d].summaryType && a.summary.push({nm: e[d].name, st: e[d].summaryType, v: "", sr: e[d].summaryRound, srt: e[d].summaryRoundType || "round"})
            } else this.p.grouping = !1; else this.p.grouping = !1
        })
    }, groupingPrepare: function (d, h, e, a) {
        this.each(function () {
            var f = this.p.groupingView, g = this, b, j = f.groupField.length, k, i, l, r = 0;
            for (b = 0; b < j; b++)k = f.groupField[b], l = f.displayField[b],
                ...
                dataIndex: k, value: i, displayValue: l, startRow: a, cnt: 1, summary: []}), f.lastvalues[b] = i, f.counters[b] = {cnt: 1, pos: f.groups.length - 1, summary: c.extend(!0, [], f.summary)}) : (f.counters[b].cnt += 1, f.groups[f.counters[b].pos].cnt = f.counters[b].cnt), c.each(f.counters[b].summary, function () {
        ...
        groupingToggle: function (d) {
            this.each(function () {
                var h = this.p.groupingView, e = d.split("_"), a = parseInt(e[e.length - 2], 10);
                e.splice(e.length - 2, 2);
                var e = e.join("_"), f = h.minusicon, g = h.plusicon, b = c("#" + c.jgrid.jqID(d)), b = b.length ? b[0].nextSibling : null, j = c("#" + c.jgrid.jqID(d) + " span.tree-wrap-" + this.p.direction), k = !1;
                if (j.hasClass(f)) {
                    if (h.showSummaryOnHide) {
                        if (b)for (; b && !(c(b).hasClass("jqfoot") && parseInt(c(b).attr("jqfootlevel"), 10) <= a);)c(b).hide(), b = b.nextSibling
                    } else if (b)for (; b && !c(b).hasClass(e + "_" +
                        ("" + a)) && !c(b).hasClass(e + "_" + ("" + (a - 1)));)c(b).hide(), b = b.nextSibling;
            ...
            return this.each(function () {
                function e(a, d, b) {
                    ...
                    if (0 === d)c = b[a]; else {
                        var e = b[a].idx;
                        if (0 === e)c = b[a]; else for (; 0 <= a; a--)if (b[a].idx === e - d) {
                            c = b[a];
                            break
                        }
                    }
                ...
                var a = this, f = a.p.groupingView, g = "", b = "", j, k, i = f.groupCollapse ? f.plusicon : f.minusicon, l, r = [], w = f.groupField.length, i = i + (" tree-wrap-" + a.p.direction);
                ...
                var t = 0, x = c.makeArray(f.groupSummary);
                x.reverse();
                c.each(f.groups, function (s, m) {
                    ...
                    if (w -
                        1 === m.idx) {
                        var o = f.groups[s + 1], p, n, B = void 0 !== o ? f.groups[s + 1].startRow : d.length;
        ...
        }, groupingCalculations: {handler: function (d, c, e, a, f, g) {
            var b = {sum: function () {
    ...
    d.jgrid.extend({setTreeNode: function (a, c) {
        return this.each(function () {
            ...
            if (b.grid && b.p.treeGrid)for (var h = b.p.expColInd, e = b.p.treeReader.expanded_field, i = b.p.treeReader.leaf_field, g = b.p.treeReader.level_field, f = b.p.treeReader.icon_field, l = b.p.treeReader.loaded, k, m, n, j; a < c;)j = b.p.data[b.p._index[b.rows[a].id]], "nested" == b.p.treeGridModel && !j[i] && (k = parseInt(j[b.p.treeReader.left_field], 10), m = parseInt(j[b.p.treeReader.right_field], 10), j[i] = m === k + 1 ? "true" : "false", b.rows[a].cells[b.p._treeleafpos].innerHTML =
                ...
                var a = d(a.target || a.srcElement, b.rows).closest("tr.jqgrow")[0].id, c = b.p._index[a];
        ...
        return this.each(function () {
            var a = this, c = 0, b = !1, h, e, i, g = [];
            if (a.p.treeGrid) {
                a.p.treedatatype || d.extend(a.p, {treedatatype: a.p.datatype});
                a.p.subGrid = !1;
                a.p.altRows = !1;
                a.p.pgbuttons = !1;
                a.p.pginput = !1;
                ...
                a.p.expColInd = 0;
                a.p.treeIcons =
                    d.extend({plus: "ui-icon-triangle-1-" + ("rtl" == a.p.direction ? "w" : "e"), minus: "ui-icon-triangle-1-s", leaf: "ui-icon-radio-off"}, a.p.treeIcons || {});
                "nested" == a.p.treeGridModel ? a.p.treeReader = d.extend({level_field: "level", left_field: "lft", right_field: "rgt", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded", icon_field: "icon"}, a.p.treeReader) : "adjacency" == a.p.treeGridModel && (a.p.treeReader = d.extend({level_field: "level", parent_id_field: "parent", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded",
                    icon_field: "icon"}, a.p.treeReader));
                ...
                d.each(a.p.treeReader, function (b, e) {
                    if (e && d.inArray(e, g) === -1) {
                        ...
                        c++;
                        a.p.colNames.push(e);
                        a.p.colModel.push({name: e, width: 1, hidden: true, sortable: false, resizable: false, hidedlg: true, editable: true, search: false})
                    }
                })
            }
        })
        ...
        expandRow: function (a) {
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var b = d(c).jqGrid("getNodeChildren", a), h = c.p.treeReader.expanded_field, e = c.rows;
                    d(b).each(function () {
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var b = d(c).jqGrid("getNodeChildren", a), h = c.p.treeReader.expanded_field, e = c.rows;
                    d(b).each(function () {
                        var a = d.jgrid.getAccessor(this,
                            c.p.localReader.id);
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid)switch (c.p.treeGridModel) {
                    ...
                    case "adjacency":
                        ...
                        d(c.p.data).each(function () {
                            (null === this[h] || "null" == ("" + this[h]).toLowerCase()) &&
                            a.push(this)
                        })
                }
            });
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                    case "nested":
                        var b = this.p.treeReader.left_field, h = this.p.treeReader.right_field,
                            e = this.p.treeReader.level_field, i = parseInt(a[b], 10), g = parseInt(a[h], 10), f = parseInt(a[e], 10);
                        d(this.p.data).each(function () {
                            if (parseInt(this[e], 10) === f - 1 && parseInt(this[b], 10) < i && parseInt(this[h], 10) > g)return c = this, !1
                        });
                        break;
                    case "adjacency":
                        var l = this.p.treeReader.parent_id_field, k = this.p.localReader.id;
                        d(this.p.data).each(function () {
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid)switch (this.p.treeGridModel) {
                    case "nested":
                        var b =
                            this.p.treeReader.left_field, h = this.p.treeReader.right_field, e = this.p.treeReader.level_field, i = parseInt(a[b], 10), g = parseInt(a[h], 10), f = parseInt(a[e], 10);
                        d(this.p.data).each(function () {
            ...
            this.each(function () {
                ...
                if (this.grid &&
                    ...
                    case "nested":
                        var h = this.p.treeReader.left_field, e = this.p.treeReader.right_field, i = this.p.treeReader.level_field, g = parseInt(a[h], 10), f = parseInt(a[e], 10), l = parseInt(a[i], 10);
                        d(this.p.data).each(function () {
            ...
            this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var b = d(this).jqGrid("getNodeAncestors", a), h = this.p.treeReader.expanded_field;
                    d(b).each(function () {
                        c = c && this[h];
                        if (!c)return!1
                    })
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var c = this.p.treeReader.expanded_field, b = this.p.treeReader.parent_id_field, h = this.p.treeReader.loaded, e = this.p.treeReader.level_field, i = this.p.treeReader.left_field, g = this.p.treeReader.right_field;
                    if (!a[c]) {
                        var f = d.jgrid.getAccessor(a, this.p.localReader.id),
                            l = d("#" + d.jgrid.jqID(f), this.grid.bDiv)[0], k = this.p._index[f];
                        d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (a[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (a[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" == this.p.treeGridModel ? d(this).jqGrid("setGridParam",
                            {postData: {nodeid: f, n_left: a[i], n_right: a[g], n_level: a[e]}}) : d(this).jqGrid("setGridParam", {postData: {nodeid: f, parentid: a[b], n_level: a[e]}}), d(this).trigger("reloadGrid"), a[h] = !0, "nested" == this.p.treeGridModel ? d(this).jqGrid("setGridParam", {postData: {nodeid: "", n_left: "", n_right: "", n_level: ""}}) : d(this).jqGrid("setGridParam", {postData: {nodeid: "", parentid: "", n_level: ""}}))
                    }
                }
            })
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    k = e.select();
                    e = 0;
                    for (i = k.length; e < i; e++)g = k[e], f.push(g), d(this).jqGrid("collectChildrenSortTree",
                        f, g, a, c, b, h);
                    d.each(f, function (a) {
        ...
        setTreeRow: function (a, c) {
            ...
            return this.each(function () {
                var c = this.p.localReader.id, b, h = this.p.treeReader.left_field, e = this.p.treeReader.right_field, i, g, f;
                if (this.grid && this.p.treeGrid && (b = this.p._index[a], void 0 !== b)) {
                    ...
                    if (0 < l.length)for (b = 0; b < l.length; b++)d(this).jqGrid("delRowData",
                        l[b][c]);
                    if ("nested" === this.p.treeGridModel) {
                        ...
                        c = d.jgrid.from(this.p.data).greater(e, i, {stype: "integer"}).select();
            ...
            var e = this[0];
            if (b) {
                var i = e.p.treeReader.expanded_field, g = e.p.treeReader.leaf_field, f = e.p.treeReader.level_field, l = e.p.treeReader.parent_id_field,
                    k = e.p.treeReader.left_field, m = e.p.treeReader.right_field, n = e.p.treeReader.loaded, j, r, q, t, p;
                j = 0;
                var s = c, u;
                void 0 === h && (h = !1);
                if (void 0 === a || null === a) {
                ...
                u = !1;
                if (void 0 === c || null === c || "" === c)s = c = null, j = "last", t = e.p.tree_root_level, p = e.p.data.length + 1; else if (j = "after", r = e.p._index[c], q = e.p.data[r], c = q[e.p.localReader.id], t = parseInt(q[f], 10) + 1, p = d(e).jqGrid("getFullTreeNode",
                ...
                if ("nested" ===
                    ...
                    if (null !== c) {
                        ...
                        f = d.jgrid.from(e.p.data).greater(m,
                            g, {stype: "integer"}).select();
