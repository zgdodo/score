...
$(document).ready(function () {
    ...
    function checkComment() {
        var filePath = $("input[name='attachment2']").val();
        if (filePath == undefined || $.trim(filePath) == "") {
            alert("请选择上传文件");
            return false;
        }
    ...
    $("#queryList").jqGrid({
        ...
        colModel: [
            ...
            {name: 'exNumber', index: 'exNumber', width: '90%', searchoptions: {sopt: ['eq', 'bw', 'ew', 'cn']},
                editable: true, editrules: {required: true, number: true}},
            {name: 'stuName', index: 'stuName', width: '80%', searchoptions: {sopt: ['eq', 'bw', 'ew', 'cn']}, editable: true},
...
//         ---------评价查询分割线-------------
    $("#commonList").jqGrid({
        ...
        colModel: [
            {name: 'stuNumber', index: 'stuNumber', width: '50%', searchoptions: {sopt: ['eq', 'bw', 'ew', 'cn']},
                editable: true, editrules: {required: true, number: true}},
        ...
        <form method="post" id="importForm" enctype="MULTIPART/FORM-DATA">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="submit" name="fileSub" value="导入成绩"/>
        ...
        <form method="post" id="importCommon" enctype="MULTIPART/FORM-DATA">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="submit" name="fileSub2" value="导入评语"/>
                        <%--<button id="fileSub"></button>--%>
                    </td>
