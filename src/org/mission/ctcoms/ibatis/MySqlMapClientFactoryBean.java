 ...
 * @see #setDataSource
 * @see org.springframework.orm.ibatis.SqlMapClientTemplate#setSqlMapClient
 * @see org.springframework.orm.ibatis.SqlMapClientTemplate#setDataSource
 */
public class MySqlMapClientFactoryBean implements FactoryBean, InitializingBean {
     ...
     * @see org.springframework.orm.ibatis.SqlMapClientTemplate#setDataSource
     * @see org.springframework.orm.ibatis.SqlMapClientTemplate#queryForPaginatedList
     */
    ...
    protected SqlMapClient buildSqlMapClient(
        ...
        try {
            stateField = configParser.getClass().getDeclaredField("state");
        ...
        //反射取设置cache的方法，执行
        Method wireUpCacheModels = null;

            wireUpCacheModels = sqlMapConfig.getClass().getDeclaredMethod(
                    "wireUpCacheModels");
